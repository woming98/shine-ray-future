...
export const FORCE_MOTION_EXERCISES: Exercise[] = [
  ...
  // Position and Movement - Question 4
  {
    ...
    answer: '12 m',
    explanation: 'The distance travelled equals the area under the velocity-time graph. Using the trapezium area from 0 to 4 s gives 12 m.',
    difficulty: 1,
    points: 10,
    hints: [
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/projectile-motion/pjm-007-option-a.png',
      '/physics/exercises/projectile-motion/pjm-007-option-b.png',
      '/physics/exercises/projectile-motion/pjm-007-option-c.png',
      '/physics/exercises/projectile-motion/pjm-007-option-d.png',
    ],
    answer: '/physics/exercises/projectile-motion/pjm-007-option-d.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/projectile-motion/pjm-030-option-a.png',
      '/physics/exercises/projectile-motion/pjm-030-option-b.png',
      '/physics/exercises/projectile-motion/pjm-030-option-c.png',
      '/physics/exercises/projectile-motion/pjm-030-option-d.png',
    ],
    answer: '/physics/exercises/projectile-motion/pjm-030-option-d.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/circular-motion/cm-003-option-a.png',
      '/physics/exercises/circular-motion/cm-003-option-b.png',
      '/physics/exercises/circular-motion/cm-003-option-c.png',
      '/physics/exercises/circular-motion/cm-003-option-d.png',
    ],
    answer: '/physics/exercises/circular-motion/cm-003-option-d.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/circular-motion/cm-023-option-a.png',
      '/physics/exercises/circular-motion/cm-023-option-b.png',
      '/physics/exercises/circular-motion/cm-023-option-c.png',
      '/physics/exercises/circular-motion/cm-023-option-d.png',
    ],
    answer: '/physics/exercises/circular-motion/cm-023-option-c.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/circular-motion/cm-025-option-a.png',
      '/physics/exercises/circular-motion/cm-025-option-b.png',
      '/physics/exercises/circular-motion/cm-025-option-c.png',
      '/physics/exercises/circular-motion/cm-025-option-d.png',
    ],
    answer: '/physics/exercises/circular-motion/cm-025-option-b.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/circular-motion/cm-026-option-a.png',
      '/physics/exercises/circular-motion/cm-026-option-b.png',
      '/physics/exercises/circular-motion/cm-026-option-c.png',
      '/physics/exercises/circular-motion/cm-026-option-d.png',
    ],
    answer: '/physics/exercises/circular-motion/cm-026-option-b.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/circular-motion/cm-032-option-a.png',
      '/physics/exercises/circular-motion/cm-032-option-b.png',
      '/physics/exercises/circular-motion/cm-032-option-c.png',
      '/physics/exercises/circular-motion/cm-032-option-d.png',
    ],
    answer: '/physics/exercises/circular-motion/cm-032-option-d.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/gravitation/grav-031-option-a.png',
      '/physics/exercises/gravitation/grav-031-option-b.png',
      '/physics/exercises/gravitation/grav-031-option-c.png',
      '/physics/exercises/gravitation/grav-031-option-d.png',
    ],
    answer: '/physics/exercises/gravitation/grav-031-option-c.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/optics-propagation/op-004-option-a.png',
      '/physics/exercises/optics-propagation/op-004-option-b.png',
      '/physics/exercises/optics-propagation/op-004-option-c.png',
      '/physics/exercises/optics-propagation/op-004-option-d.png',
    ],
    answer: '/physics/exercises/optics-propagation/op-004-option-a.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/optics-propagation/op-007-option-a.png',
      '/physics/exercises/optics-propagation/op-007-option-b.png',
      '/physics/exercises/optics-propagation/op-007-option-c.png',
      '/physics/exercises/optics-propagation/op-007-option-d.png',
    ],
    answer: '/physics/exercises/optics-propagation/op-007-option-d.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/optics-propagation/op-016-option-a.png',
      '/physics/exercises/optics-propagation/op-016-option-b.png',
      '/physics/exercises/optics-propagation/op-016-option-c.png',
      '/physics/exercises/optics-propagation/op-016-option-d.png',
    ],
    answer: '/physics/exercises/optics-propagation/op-016-option-d.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/optics-propagation/op-021-option-a.png',
      '/physics/exercises/optics-propagation/op-021-option-b.png',
      '/physics/exercises/optics-propagation/op-021-option-c.png',
      '/physics/exercises/optics-propagation/op-021-option-d.png',
    ],
    answer: '/physics/exercises/optics-propagation/op-021-option-c.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/optics-propagation/op-022-option-a.png',
      '/physics/exercises/optics-propagation/op-022-option-b.png',
      '/physics/exercises/optics-propagation/op-022-option-c.png',
      '/physics/exercises/optics-propagation/op-022-option-d.png',
    ],
    answer: '/physics/exercises/optics-propagation/op-022-option-c.png',
    explanation:
  ...
  },
  {
    ...
    options: [
      '/physics/exercises/optics-propagation/op-024-option-a.png',
      '/physics/exercises/optics-propagation/op-024-option-b.png',
      '/physics/exercises/optics-propagation/op-024-option-c.png',
      '/physics/exercises/optics-propagation/op-024-option-d.png',
    ],
    answer: '/physics/exercises/optics-propagation/op-024-option-c.png',
    explanation:
  ...
  },
{
  ...
  {
    id: 'wol-021',
    question: 'Given that the wavelengths of visible light range from $4 x 10^{-7} \\mathrm{~m}$ to $7 x 10^{-7} \\mathrm{~m}$, which of the following combinations of wavelengths for infrared, red and violet lights is possible?',
    options: [
      'Infrared: $1 x 10^{-4} \\mathrm{~m}$; Red light: $7 x 10^{-7} \\mathrm{~m}$; Violet light: $4 x 10^{-7} \\mathrm{~m}$',
      'Infrared: $1 x 10^{-7} \\mathrm{~m}$; Red light: $7 x 10^{-7} \\mathrm{~m}$; Violet light: $4 x 10^{-7} \\mathrm{~m}$',
      'Infrared: $1 x 10^{-4} \\mathrm{~m}$; Red light: $4 x 10^{-7} \\mathrm{~m}$; Violet light: $7 x 10^{-7} \\mathrm{~m}$',
      'Infrared: $1 x 10^{-7} \\mathrm{~m}$; Red light: $4 x 10^{-7} \\mathrm{~m}$; Violet light: $7 x 10^{-7} \\mathrm{~m}$'
    ],
    answer: 'Infrared: $1 x 10^{-4} \\mathrm{~m}$; Red light: $7 x 10^{-7} \\mathrm{~m}$; Violet light: $4 x 10^{-7} \\mathrm{~m}$',
    explanation: 'Infrared has a wavelength longer than visible light, so it should be $1 x 10^{-4} \\mathrm{~m}$. Red has the longest wavelength in visible light, so it should be $7 x 10^{-7} \\mathrm{~m}$. Violet has the shortest visible wavelength, so it should be $4 x 10^{-7} \\mathrm{~m}$.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-021-question.png'],
    hints: ['Infrared is longer than visible light.', 'Red is longer than violet within the visible range.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    ...
    options: ['(2) only', '(3) only', '(1) & (2) only', '(1) & (3) only'],
    answer: '(1) & (3) only',
    explanation: 'Light is a transverse electromagnetic wave. It does undergo diffraction, so statement (2) is false. Light also carries energy.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['All waves can show diffraction.', 'Electromagnetic waves carry energy.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-023',
    question: 'A radio station broadcasts at a frequency of 94 MHz. Find the wavelength of the radio waves.',
    options: ['0.31 m', '3.19 m', '31.91 m', '3191 m'],
    answer: '3.19 m',
    explanation: 'Using $v=f\\lambda$, with $v=3 x 10^8 \\mathrm{~m} \\mathrm{~s}^{-1}$ and $f=94 x 10^6 \\mathrm{~Hz}$, the wavelength is $\\lambda=3.19 \\mathrm{~m}$.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $v=f\\lambda$.', 'Convert MHz to Hz first.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-024',
    question: 'Which of the following statements concerning infra-red radiation is correct?',
    options: ['Infra-red is red in colour.', 'Infra-red can be detected by a Geiger-Muller counter.', 'Infra-red can be used to sterilize drinking water.', 'Warm objects emit infra-red.'],
    answer: 'Warm objects emit infra-red.',
    explanation: 'Infra-red is invisible. Warm or hot objects emit infra-red radiation. Geiger-Muller counters detect ionizing radiation, and sterilizing drinking water is commonly done using ultra-violet.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Infra-red is thermal radiation.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-025',
    question: 'Arrange the following electromagnetic waves in ascending order of frequencies.\n\n(1) X-rays\n(2) Ultra-violet rays\n(3) Radio waves',
    options: ['(1), (2), (3)', '(2), (1), (3)', '(3), (1), (2)', '(3), (2), (1)'],
    answer: '(3), (2), (1)',
    explanation: 'Frequency increases across the electromagnetic spectrum from radio waves to gamma rays. So the ascending order here is radio waves, ultra-violet rays, then X-rays.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Radio waves have the lowest frequency here.', 'X-rays have the highest frequency among these three.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-026',
    question: 'Which of the following is not an application of the corresponding electromagnetic wave?',
    options: [
      'Ultra-violet - Camera autofocusing',
      'Infra-red - Detecting survivors buried in landslides',
      'Microwaves - Satellite communication',
      'X-rays - Detecting weapons hidden in suitcases'
    ],
    answer: 'Ultra-violet - Camera autofocusing',
    explanation: 'Camera autofocusing commonly uses infra-red or ultrasound, not ultra-violet. Infra-red can help detect warm survivors, microwaves are used in satellite communication, and X-rays can detect hidden weapons in luggage.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Camera autofocusing does not use ultra-violet.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-027',
    question: 'Part of the electromagnetic spectrum is shown above. Which of the following statements is/are correct?\n\n(1) $P$ is ultra-violet and $Q$ is infra-red.\n(2) The wavelength of $P$ is shorter than that of $Q$.\n(3) The speed of $P$ in vacuum is higher than that of $Q$.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) & (2) only',
    explanation: 'Ultra-violet lies between X-rays and visible light, while infra-red lies between visible light and microwaves. Wavelength increases toward the right in this part of the spectrum, so $P$ has a shorter wavelength than $Q$. All electromagnetic waves travel at the same speed in vacuum.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['All electromagnetic waves have the same speed in vacuum.', 'Use the standard EM spectrum order.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-028',
    question: 'Which of the following is an application of ultra-violet radiation?',
    options: ['Camera auto-focusing', 'Detecting cracks in railway tracks', 'Detecting survivors buried in landslides', 'Sterilization of drinking water'],
    answer: 'Sterilization of drinking water',
    explanation: 'Ultra-violet radiation is used for sterilization. Camera auto-focusing commonly uses infra-red or ultrasound, railway crack detection uses ultrasound, and buried survivors are commonly detected using infra-red.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Ultra-violet can kill microorganisms.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-029',
    question: 'Which of the following equipment emits waves which are electromagnetic in nature?\n\n(1) a television remote control\n(2) a microwave oven\n(3) an ultrasonic scanner for examining foetuses',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) & (2) only',
    explanation: 'A television remote control emits infra-red radiation and a microwave oven uses microwaves, both of which are electromagnetic. An ultrasonic scanner uses sound waves, which are mechanical, not electromagnetic.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Infra-red and microwaves are electromagnetic waves.', 'Ultrasound is sound.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-030',
    question: 'Scientists have discovered that ozone molecules in the earth\'s atmosphere are being destroyed. Which of the following electromagnetic waves is mainly responsible for causing hazard to human health as a result of the damaging of the ozone layer?',
    options: ['gamma radiation', 'visible light', 'infra-red', 'ultra-violet'],
    answer: 'ultra-violet',
    explanation: 'The ozone layer absorbs much of the Sun\'s ultra-violet radiation. If the ozone layer is damaged, more ultra-violet reaches the Earth\'s surface and increases health hazards such as skin cancer.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['The ozone layer mainly protects us from UV.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-031',
    question: 'Which of the following is/are the reason(s) for not over-using ultra-violet lamps to produce a suntan effect?\n\n(1) Ultra-violet radiation is highly penetrating and will damage body tissue.\n(2) Ultra-violet radiation has a strong heating effect and will damage body tissue.\n(3) Over-exposure to ultra-violet radiation may cause skin cancer.',
    options: ['(2) only', '(3) only', '(1) & (2) only', '(1) & (3) only'],
    answer: '(3) only',
    explanation: 'Ultra-violet is not highly penetrating like X-rays or gamma rays, and it is not known for a strong heating effect like infra-red. The real hazard is that over-exposure to ultra-violet radiation may cause skin cancer.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['UV is hazardous mainly because of biological damage, not strong heating.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-032',
    question: 'The photograph shows a digital video camera recorder. The recorder has a night-shot function for capturing images in the dark. Which of the following electromagnetic waves is employed by the recorder in capturing images in the dark?',
    options: ['radio waves', 'infra-red', 'ultra-violet', 'X-rays'],
    answer: 'infra-red',
    explanation: 'Infra-red can be used in night-shot systems to capture images in the dark.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-032-question.png'],
    hints: ['Night-shot commonly uses infra-red.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-033',
    question: 'A ship is equipped with certain devices. Which device is not an application of electromagnetic waves?',
    options: ['the radar system', 'the sonar system', 'the infra-red system for night navigation', 'the wireless telecommunication system'],
    answer: 'the sonar system',
    explanation: 'Radar uses microwaves, infra-red systems use infra-red radiation, and wireless communication uses radio waves. Sonar uses ultrasound, which is a sound wave, not an electromagnetic wave.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Sonar uses sound, not EM waves.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-034',
    question: 'Which of the following shows the correct order of the relative positions of five electromagnetic waves in the electromagnetic spectrum, in the order of decreasing wavelength?',
    options: [
      'microwaves, infra-red, visible light, ultra-violet, X-rays',
      'microwaves, ultra-violet, visible light, infra-red, X-rays',
      'X-rays, infra-red, visible light, ultra-violet, microwaves',
      'X-rays, ultra-violet, visible light, infra-red, microwaves'
    ],
    answer: 'microwaves, infra-red, visible light, ultra-violet, X-rays',
    explanation: 'In decreasing wavelength, the order here is microwaves, infra-red, visible light, ultra-violet, then X-rays.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Longer to shorter: microwaves to X-rays.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-035',
    question: 'Which of the following phenomena demonstrate(s) that light is an electromagnetic wave?\n\n(1) Light bends when it travels across a boundary from one medium into another.\n(2) Light reflects when it meets a polished metal surface.\n(3) Light can travel from the Sun to the Earth.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(3) only',
    explanation: 'Refraction and reflection show that light is a wave, but they do not specifically show that it is electromagnetic. The fact that light can travel through the vacuum between the Sun and the Earth shows that it is electromagnetic.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Electromagnetic waves can travel through vacuum.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-036',
    question: 'Which of the following graphs showing the relationship among velocity ($v$), frequency ($f$) and wavelength ($\\lambda$) of electromagnetic waves in vacuum is/are correct?\n\n(1)\n(2)\n(3)',
    options: ['(1) only', '(2) only', '(1) & (3) only', '(2) & (3) only'],
    answer: '(1) & (3) only',
    explanation: 'The speed of electromagnetic waves in vacuum is constant, so a graph of $v$ against $f$ is horizontal and a graph of $v$ against $\\lambda$ is also horizontal. Since $v=f\\lambda$ and $v$ is constant, $f$ and $\\lambda$ are inversely proportional, so the straight-line graph in (2) is not correct.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-036-question.png'],
    hints: ['In vacuum, all EM waves travel at the same speed.', 'For constant $v$, $f$ and $\\lambda$ are inversely proportional.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-037',
    question: 'In the figure, a laser speed gun is used to check for speeding. A car is approaching the speed gun. The speed gun emits a laser pulse. The speed gun receives the reflected pulse from the car after $3.6 x 10^{-7} \\mathrm{~s}$. After $0.2 \\mathrm{~s}$, the speed gun emits another laser pulse. The speed gun receives the reflected pulse from the car after $3.1 x 10^{-7} \\mathrm{~s}$. What is the estimated speed of the car? Given that the speed of the laser pulse is $3 x 10^8 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    options: ['$15.0 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$20.1 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$37.5 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$40.2 \\mathrm{~m} \\mathrm{~s}^{-1}$'],
    answer: '$37.5 \\mathrm{~m} \\mathrm{~s}^{-1}$',
    explanation: 'The initial distance is $\\tfrac{1}{2}(3 x 10^8)(3.6 x 10^{-7})=54 \\mathrm{~m}$. The later distance is $\\tfrac{1}{2}(3 x 10^8)(3.1 x 10^{-7})=46.5 \\mathrm{~m}$. The car moves $54-46.5=7.5 \\mathrm{~m}$ in $0.2 \\mathrm{~s}$, so its speed is $37.5 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-037-question.png'],
    hints: ['The measured time is for a round trip.', 'Use distance change over 0.2 s.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-038',
    question: 'Compare the time taken for the following waves to travel a distance of 100 m.\n\n$T_1$: Water waves with frequency $0.5 \\mathrm{~Hz}$ and wavelength $2 \\mathrm{~m}$\n$T_2$: Sound waves travelling at $340 \\mathrm{~m} \\mathrm{~s}^{-1}$\n$T_3$: Microwaves emitted by an artificial satellite\n\nThe time taken in descending order is',
    options: ['$T_1 > T_2 > T_3$', '$T_2 > T_3 > T_1$', '$T_3 > T_2 > T_1$', '$T_1 > T_3 > T_2$'],
    answer: '$T_1 > T_2 > T_3$',
    explanation: 'Water waves are slowest, sound waves are faster, and microwaves travel fastest. For the same distance, the slower the speed, the longer the time taken.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $t=d/v$.', 'Compare the speeds only.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-039',
    question: 'In Young\'s double slit experiment, which of the following can increase the separation of the interference fringes on the screen?\n\n(1) Increase the distance between the double slits and the screen.\n(2) Increase the wavelength of the light.\n(3) Increase the distance between the light source and the double slits.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) & (2) only',
    explanation: 'The fringe spacing is $\\Delta y = \\dfrac{\\lambda D}{a}$. Increasing the screen distance $D$ or the wavelength $\\lambda$ increases the fringe spacing. The distance between the light source and the double slits does not affect it.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $\\Delta y = \\lambda D / a$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-040',
    question: 'When light of wavelength $\\lambda$ is incident normally on a diffraction grating with $p$ lines per millimetre, the second-order maximum is at an angle $\\theta$ from the central position. When light of wavelength $5\\lambda/4$ is incident normally on another grating with $3p$ lines per millimetre, the first-order maximum is formed at an angle $\\phi$ from the central position. Which of the following relations is correct?',
    options: [
      '$\\sin \\phi = (5 \\sin \\theta)/12$',
      '$\\sin \\phi = \\sin (5\\theta/12)$',
      '$\\sin \\phi = \\sin (15\\theta/4)$',
      '$\\sin \\phi = (15 \\sin \\theta)/8$'
    ],
    answer: '$\\sin \\phi = (15 \\sin \\theta)/8$',
    explanation: 'Using the grating equation $d \\sin \\alpha = n\\lambda$: for the first grating, $\\left(\\dfrac{10^{-3}}{p}\\right)\\sin\\theta = 2\\lambda$. For the second, $\\left(\\dfrac{10^{-3}}{3p}\\right)\\sin\\phi = \\dfrac{5\\lambda}{4}$. Eliminating $\\lambda$ gives $\\sin\\phi = \\dfrac{15}{8}\\sin\\theta$.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    hints: ['Use the grating equation $d\\sin\\alpha=n\\lambda$.', 'Convert lines per millimetre to grating spacing.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-041',
    question: 'In Young\'s double-slit experiment, which of the following combinations of monochromatic light, the slit separation and the slit-to-screen distance would produce the greatest fringe separation on the screen?',
    options: [
      'red light; slit separation 1 mm; slit-to-screen distance 1 m',
      'red light; slit separation 1 mm; slit-to-screen distance 2 m',
      'red light; slit separation 2 mm; slit-to-screen distance 1 m',
      'blue light; slit separation 1 mm; slit-to-screen distance 2 m'
    ],
    answer: 'red light; slit separation 1 mm; slit-to-screen distance 2 m',
    explanation: 'Fringe separation is $\\Delta y = \\dfrac{\\lambda D}{a}$. To maximize it, use longer wavelength light (red), a smaller slit separation, and a larger slit-to-screen distance. That gives option B.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $\\Delta y = \\lambda D / a$.', 'Increase $\\lambda$ and $D$, decrease $a$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-042',
    question: 'When light travels from glass to air, the emergent light would show an increase in\n\n(1) frequency\n(2) wavelength\n(3) velocity',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(2) & (3) only',
    explanation: 'When light goes from glass to air, its frequency remains unchanged, but its speed increases. Since $v=f\\lambda$ and $f$ is constant, the wavelength also increases.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Frequency stays constant across media.', 'If speed increases, wavelength increases.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-043',
    question: 'In a Young\'s double-slit experiment, the light source gives out monochromatic light of wavelength 400 nm. If the path difference of light from the two slits $X$ and $Y$ at point $P$ on the screen is 3000 nm, which of the following is/are correct?\n\n(1) At point $P$, the 7th dark fringe is observed.\n(2) If the light source is moved closer to the slits, the fringe separation on the screen will increase.\n(3) If light of wavelength 500 nm is used, point $P$ will become a bright fringe.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(3) only',
    explanation: 'For 400 nm light, the path difference is $3000/400 = 7.5\\lambda$, so point $P$ is the 8th dark fringe, not the 7th. Fringe spacing is independent of the distance between the source and the slits. For 500 nm light, the path difference is $3000/500 = 6\\lambda$, so point $P$ becomes a bright fringe.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-043-question.png'],
    hints: ['Dark fringes occur at half-integer multiples of $\\lambda$.', 'Moving the source does not change fringe spacing.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-044',
    question: 'A student prepares a double-slit interference experiment as shown. $a$ is the slit separation and $b$ is the slit width. However, no interference fringe can be observed on the screen. Which of the following improvements should be taken?',
    options: ['decrease $x$', 'decrease $D$', 'increase $b$', 'decrease $a$'],
    answer: 'decrease $a$',
    explanation: 'The wavelength of light is very small, so to obtain observable interference fringes the slit separation $a$ must be made much smaller. This increases the fringe separation.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-044-question.png'],
    hints: ['Observable interference needs small slit separation.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-045',
    question: 'When monochromatic light passes through a diffraction grating, a pattern of maxima and minima is observed as shown. Which of the following combinations would produce the largest angle $\\theta$ between the two first-order maxima?',
    options: [
      'Grating: 200 lines per mm; Colour: green',
      'Grating: 200 lines per mm; Colour: red',
      'Grating: 400 lines per mm; Colour: green',
      'Grating: 400 lines per mm; Colour: red'
    ],
    answer: 'Grating: 400 lines per mm; Colour: red',
    explanation: 'Using $d\\sin\\theta = n\\lambda$, a larger diffraction angle requires a smaller grating spacing $d$ and a larger wavelength $\\lambda$. More lines per mm means smaller $d$, and red light has a longer wavelength than green light.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-045-question.png'],
    hints: ['More lines per mm means smaller spacing.', 'Red light has longer wavelength than green.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-046',
    question: 'A plane diffraction grating has a ruling of 5000 lines per cm. When monochromatic light of wavelength 500 nm is incident normally onto it, which of the following descriptions is/are correct?\n\n(1) The spacing between the rulings is 2000 nm.\n(2) The second-order maximum occurs at an angle of $30^{\\circ}$ from the central line.\n(3) There is no third-order maximum in the diffracted pattern.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) & (2) only',
    explanation: 'The grating spacing is $d=\\dfrac{1\\times10^{-2}}{5000}=2\\times10^{-6}\\,\\mathrm{m}=2000\\,\\mathrm{nm}$. For the second-order maximum, $d\\sin\\theta = 2\\lambda$, so $(2\\times10^{-6})\\sin\\theta = 2(500\\times10^{-9})$, giving $\\theta=30^\\circ$. A third-order maximum does exist because $\\sin\\theta_3 = 3\\lambda/d = 0.75$.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    hints: ['Convert lines per cm to spacing first.', 'Use $d\\sin\\theta=n\\lambda$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-047',
    question: 'In a Young\'s double-slit experiment, a monochromatic light source is used. Which of the following methods would increase the fringe separation on the screen?\n\n(1) Use a monochromatic light source of longer wavelength.\n(2) Use a double slit with greater slit separation.\n(3) Use a double slit with larger slit width.',
    options: ['(1) only', '(1) & (2) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) only',
    explanation: 'Fringe separation is $\\Delta y = \\dfrac{\\lambda D}{a}$. Increasing the wavelength increases fringe separation. Increasing the slit separation decreases it. Changing slit width does not directly change fringe separation.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $\\Delta y = \\lambda D / a$.'],
    type: 'multiple_choice',
  ...
  {
    id: 'wol-048',
    question: 'A beam of monochromatic light is incident normally on a diffraction grating. The third-order maxima are found at angles of $45^{\\circ}$ from the central line. What is the highest order of diffracted maximum that can be observed?',
    options: ['3rd order', '4th order', '5th order', '6th order'],
    answer: '4th order',
    explanation: 'Using $d\\sin\\theta = n\\lambda$, the third-order maximum at $45^\\circ$ gives $d\\sin45^\\circ = 3\\lambda$. The highest possible order occurs when $\\sin\\theta \\le 1$, so $n_{\\max} = d/\\lambda = 3/\\sin45^\\circ \\approx 4.24$. Therefore the highest observable integer order is the 4th order.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-048-question.png'],
    hints: ['Use the known third-order maximum to find $d/\\lambda$.', 'The maximum possible order must be an integer.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-049',
    question: 'In a Young\'s double-slit experiment, monochromatic light of wavelength 550 nm is used. The fringes are formed on a screen placed at 1.0 m from the double slits. If the separation between the first and the fifth dark fringes is 5.0 mm, calculate the slit separation of the double slits.',
    options: ['$0.3 x 10^{-4} \\mathrm{~m}$', '$1.1 x 10^{-4} \\mathrm{~m}$', '$4.4 x 10^{-4} \\mathrm{~m}$', '$8.8 x 10^{-4} \\mathrm{~m}$'],
    answer: '$4.4 x 10^{-4} \\mathrm{~m}$',
    explanation: 'The fringe separation is $\\Delta y = 5.0\\,\\mathrm{mm} \\div 4 = 1.25\\,\\mathrm{mm}$. Using $\\Delta y = \\dfrac{\\lambda D}{a}$ with $\\lambda = 550\\times10^{-9}\\,\\mathrm{m}$ and $D=1.0\\,\\mathrm{m}$ gives $a = \\dfrac{550\\times10^{-9}}{1.25\\times10^{-3}} = 4.4\\times10^{-4}\\,\\mathrm{m}$.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    hints: ['Five dark fringes span four fringe spacings.', 'Use $\\Delta y = \\lambda D / a$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-050',
    question: 'Which of the following statements about a transmission diffraction grating are correct when monochromatic light is incident onto the grating?\n\n(1) The grating produces a diffraction pattern on both sides of the central line.\n(2) The angle of diffraction of the same order is directly proportional to the wavelength of the incident light.\n(3) A grating with smaller grating spacing gives a greater diffracted angle of the first maxima.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) & (3) only',
    explanation: 'The diffraction pattern is symmetric about the central line. From $d\\sin\\theta=n\\lambda$, for the same order it is $\\sin\\theta$ that is proportional to $\\lambda$, not the angle itself. A smaller grating spacing gives a larger diffraction angle.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $d\\sin\\theta=n\\lambda$.', 'Symmetry occurs on both sides of the central maximum.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-051',
    question: 'A student used the above set-up to produce a diffraction pattern on a screen. The filament lamp gives out white light. It was found that part of the second-order spectrum overlapped with the third-order one. The student suggested the following changes to eliminate the overlapping so as to obtain a pure second-order spectrum. Which of the following may be possible?\n\n(1) Move the screen closer to the grating.\n(2) Replace the grating by one with smaller grating spacing.\n(3) Insert a single slit between the filament lamp and the grating.',
    options: ['(1) only', '(2) only', '(3) only', 'None of the above'],
    answer: 'None of the above',
    explanation: 'For a diffraction grating, overlapping between different orders is set by the grating equation and wavelengths involved. Moving the screen, changing the spacing, or adding a slit does not eliminate the intrinsic overlap between the second-order and third-order spectra.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-051-question.png'],
    hints: ['Screen position changes spacing on the screen, not the angular overlap condition.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-052',
    question: 'A diffraction grating ruled with 500 lines per mm is illuminated normally by white light. If the wavelengths for yellow light and violet light are 600 nm and 400 nm respectively, which of the following statements are correct?\n\n(1) In the first-order spectrum, the violet end is closer to the central bright fringe than the red end.\n(2) The second-order image of yellow light coincides with the third-order image of violet light.\n(3) There is no fourth-order image for violet light.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) & (2) only',
    explanation: 'In the first-order spectrum, shorter wavelength light diffracts less, so violet is closer to the central bright fringe. For overlap, $(2)(600\\,\\mathrm{nm})=(3)(400\\,\\mathrm{nm})$, so the second-order yellow and third-order violet coincide. A fourth-order violet maximum still exists because the resulting diffraction angle is physically possible.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $d\\sin\\theta=n\\lambda$.', 'Compare $n\\lambda$ values for overlap.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-053',
    question: 'Which of the following correctly gives the order of magnitude of the wavelengths of infra-red radiation and ultra-violet radiation in air?',
    options: [
      'Infra-red: $10^{-2} \\mathrm{~m}$; Ultra-violet: $10^{-1} \\mathrm{~m}$',
      'Infra-red: $10^{-5} \\mathrm{~m}$; Ultra-violet: $10^{-8} \\mathrm{~m}$',
      'Infra-red: $10^{-2} \\mathrm{~m}$; Ultra-violet: $10^{-8} \\mathrm{~m}$',
      'Infra-red: $10^{-5} \\mathrm{~m}$; Ultra-violet: $10^{-10} \\mathrm{~m}$'
    ],
    answer: 'Infra-red: $10^{-5} \\mathrm{~m}$; Ultra-violet: $10^{-8} \\mathrm{~m}$',
    explanation: 'A typical order of magnitude for infra-red wavelength is about $10^{-5}\\,\\mathrm{m}$, while ultra-violet is about $10^{-8}\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Infra-red is longer than visible light.', 'Ultra-violet is shorter than visible light.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-054',
    question: 'Two identical monochromatic light sources cannot give an interference pattern. The reason(s) is/are\n\n(1) the two light sources have different amplitudes.\n(2) the two light sources have different frequency.\n(3) the two light sources do not have constant phase relationship.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(3) only',
    explanation: 'Two independent identical light sources can have the same amplitude and frequency, but they do not maintain a constant phase relationship. Without coherence, no stable interference pattern is formed.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Stable interference needs coherent sources.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-055',
    question: 'The above figure shows how the electric field of a monochromatic light wave varies with distance in air. Which description about the colour of the light and its frequency is correct?',
    options: [
      'violet; $5.0 x 10^{14}$ Hz',
      'violet; $7.5 x 10^{14}$ Hz',
      'orange; $5.0 x 10^{14}$ Hz',
      'orange; $7.5 x 10^{14}$ Hz'
    ],
    answer: 'violet; $7.5 x 10^{14}$ Hz',
    explanation: 'From the graph, the wavelength is $4 x 10^{-7}\\,\\mathrm{m}$, which corresponds to violet light. Using $c=f\\lambda$ with $c=3 x 10^8\\,\\mathrm{m\\,s^{-1}}$ gives $f=7.5 x 10^{14}\\,\\mathrm{Hz}$.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-055-question.png'],
    hints: ['Use the graph to read wavelength.', 'Then use $c=f\\lambda$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-056',
    question: 'A diffraction grating of 4000 lines per cm is placed at a distance of 0.75 m from a screen. A monochromatic light is directed perpendicularly onto the grating. The two second-order fringes on the screen are at a separation of 68.6 cm. Calculate the wavelength of the monochromatic light.',
    options: ['460 nm', '520 nm', '545 nm', '572 nm'],
    answer: '520 nm',
    explanation: 'Half the separation is $0.686/2=0.343\\,\\mathrm{m}$, so $\\tan\\theta_2 = 0.343/0.75$, giving $\\theta_2 \\approx 24.58^\\circ$. The grating spacing is $d=\\dfrac{1 x 10^{-2}}{4000}=2.5 x 10^{-6}\\,\\mathrm{m}$. Using $d\\sin\\theta = n\\lambda$ with $n=2$ gives $\\lambda \\approx 520\\,\\mathrm{nm}$.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    hints: ['Use half the fringe separation for one side.', 'Then apply $d\\sin\\theta=n\\lambda$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-057',
    question: 'A Young\'s double-slit experiment was performed using a monochromatic light source. Which change would result in a greater fringe separation on the screen?\n\n(1) Using monochromatic light source of longer wavelength\n(2) Using double slit with greater slit separation\n(3) Using double slit with larger slit width',
    options: ['(1) only', '(1) & (2) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) only',
    explanation: 'Fringe separation is $\\Delta y = \\dfrac{\\lambda D}{a}$. Increasing the wavelength increases fringe separation. Increasing slit separation decreases it. Slit width does not determine the fringe separation.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $\\Delta y = \\lambda D / a$.'],
    type: 'multiple_choice',
  ...
  {
    id: 'wol-058',
    question: 'When monochromatic light is passed through a diffraction grating, a pattern of maxima and minima is observed as shown. Which combination would produce the largest angle $\\theta$ between the first-order maxima?',
    options: [
      'Grating: 200 lines per mm; Colour: blue',
      'Grating: 200 lines per mm; Colour: red',
      'Grating: 400 lines per mm; Colour: blue',
      'Grating: 400 lines per mm; Colour: red'
    ],
    answer: 'Grating: 400 lines per mm; Colour: red',
    explanation: 'Using $d\\sin\\theta = \\lambda$ for first order, a larger angle requires smaller grating spacing $d$ and a larger wavelength $\\lambda$. More lines per mm gives smaller spacing, and red light has a longer wavelength than blue light.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-058-question.png'],
    hints: ['More lines per mm means smaller spacing.', 'Red diffracts more than blue.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-059',
    question: 'Yellow light of wavelength 590 nm is incident normally on a diffraction grating with 400 lines per mm. Find the difference in angular positions for the third-order and the fourth-order bright fringes.',
    options: ['$13.7^{\\circ}$', '$25.7^{\\circ}$', '$45.1^{\\circ}$', '$70.7^{\\circ}$'],
    answer: '$25.7^{\\circ}$',
    explanation: 'The grating spacing is $d=\\dfrac{1 x 10^{-3}}{400}$. For the fourth order, $d\\sin\\theta_4 = 4\\lambda$ gives $\\theta_4 \\approx 70.73^\\circ$. For the third order, $d\\sin\\theta_3 = 3\\lambda$ gives $\\theta_3 \\approx 45.07^\\circ$. The difference is about $25.7^\\circ$.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    hints: ['Use $d\\sin\\theta=n\\lambda$ for both orders.', 'Subtract the two angles.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-060',
    question: 'In a Young\'s double-slit experiment, a monochromatic light source of wavelength 600 nm is used. The fringe separation is 5 mm on the screen. If the slit separation is halved and a monochromatic light source of wavelength 450 nm is used instead, what is the new fringe separation?',
    options: ['1.9 mm', '3.3 mm', '7.5 mm', '13.3 mm'],
    answer: '7.5 mm',
    explanation: 'Since $\\Delta y = \\dfrac{\\lambda D}{a}$, the new fringe separation scales by $\\dfrac{450}{600} \\times \\dfrac{a}{a/2} = \\dfrac{3}{4} \\times 2 = 1.5$. Therefore the new fringe separation is $1.5 \\times 5\\,\\mathrm{mm} = 7.5\\,\\mathrm{mm}$.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-060-question.png'],
    hints: ['Use proportional change in $\\Delta y = \\lambda D / a$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-061',
    question: 'Which of the following phenomena demonstrates that light is an electromagnetic wave?',
    options: ['Light carries energy.', 'Light reflects when it meets a polished metal surface.', 'Light bends when it travels across a boundary from one medium into another.', 'Light can travel from the Sun to the Earth.'],
    answer: 'Light can travel from the Sun to the Earth.',
    explanation: 'Carrying energy, reflection, and refraction are wave behaviors in general. The key evidence that light is electromagnetic is that it can travel through the vacuum between the Sun and the Earth.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Electromagnetic waves can travel in vacuum.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    ...
    options: ['In air, the wavelength of infra-red radiation is shorter than that of ultra-violet radiation.', 'Visible light travels faster in air than in glass.', 'Microwaves travel at the speed of light in a vacuum.', 'Both light and sound exhibit diffraction.'],
    answer: 'In air, the wavelength of infra-red radiation is shorter than that of ultra-violet radiation.',
    explanation: 'Infra-red has a longer wavelength than ultra-violet. The other three statements are correct.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Infra-red is longer wavelength than visible light.', 'Ultra-violet is shorter than visible light.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-063',
    question: 'For a diffraction grating of 600 lines per mm, the diffracted red light (657 nm) coincides with the diffracted violet light (438 nm) at an angle of diffraction of $52^{\\circ}$. What are the respective orders of the diffracted red light and violet light?',
    options: ['red: 2, violet: 3', 'red: 3, violet: 4', 'red: 3, violet: 2', 'red: 4, violet: 3'],
    answer: 'red: 2, violet: 3',
    explanation: 'Using $d\\sin\\theta=n\\lambda$ with $d=\\dfrac{1 x 10^{-3}}{600}$ and $\\theta=52^\\circ$, the order for red light comes out to about 2 and the order for violet light comes out to about 3.',
    difficulty: 3,
    sectionId: 'wave-nature-of-light',
    hints: ['Use the same angle for both colours.', 'Solve for $n$ in each case.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-064',
    question: 'When monochromatic light passes through a diffraction grating, a pattern of bright fringes is formed. Which arrangement would produce the greatest angle $\\theta$ between the central and first-order bright fringes?',
    options: ['400 lines per mm; green', '400 lines per mm; blue', '200 lines per mm; green', '200 lines per mm; blue'],
    answer: '400 lines per mm; green',
    explanation: 'From $d\\sin\\theta = \\lambda$ for first order, the largest angle comes from smaller grating spacing and larger wavelength. More lines per mm gives smaller spacing, and green has a longer wavelength than blue.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-064-question.png'],
    hints: ['More lines per mm means smaller spacing.', 'Green has longer wavelength than blue.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-065',
    question: 'Which diagrams below correctly show the spectra formed from white light by a glass prism and a diffraction grating, respectively? It is known that red light travels faster than violet light in glass.\n\n($R$ = red, $V$ = violet, $W$ = white)\n\n(1)\n(2)\n(3)\n(4)',
    options: ['(1) & (3) only', '(1) & (4) only', '(2) & (3) only', '(2) & (4) only'],
    answer: '(1) & (3) only',
    explanation: 'In a prism, red light is least deviated because it travels faster in glass than violet light. In a diffraction grating, red light has the largest diffraction angle in the first-order spectrum because it has the longest wavelength.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-065-question.png'],
    hints: ['Prism: red deviates least.', 'Grating: red diffracts most in first order.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-066',
    question: 'Which of the following gives the order of magnitude of the wavelengths of ultra-violet radiation and microwave in a vacuum?',
    options: [
      'ultra-violet radiation: $10^{-8} \\mathrm{~m}$; microwave: $10^{-2} \\mathrm{~m}$',
      'ultra-violet radiation: $10^{-8} \\mathrm{~m}$; microwave: $10^{-5} \\mathrm{~m}$',
      'ultra-violet radiation: $10^{-10} \\mathrm{~m}$; microwave: $10^{-2} \\mathrm{~m}$',
      'ultra-violet radiation: $10^{-10} \\mathrm{~m}$; microwave: $10^{-5} \\mathrm{~m}$'
    ],
    answer: 'ultra-violet radiation: $10^{-8} \\mathrm{~m}$; microwave: $10^{-2} \\mathrm{~m}$',
    explanation: 'A typical order of magnitude for ultra-violet wavelength is $10^{-8}\\,\\mathrm{m}$, while microwaves are much longer, around $10^{-2}\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Ultra-violet is much shorter than visible light.', 'Microwaves are much longer than infra-red.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-067',
    question: 'Diffraction will occur when light\n(1) passes through a pinhole.\n(2) passes by a sharp edge.\n(3) passes through a slit.',
    options: ['(1) only', '(2) only', '(3) only', '(1), (2) & (3)'],
    answer: '(1), (2) & (3)',
    explanation: 'Light diffracts whenever it passes through a small opening or around an edge. A pinhole, a sharp edge and a slit can all produce diffraction.',
    difficulty: 1,
    sectionId: 'wave-nature-of-light',
    hints: ['Diffraction means spreading or bending of waves.', 'Both edges and narrow openings can cause it.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'wol-068',
    question: 'The figure below shows some of the bright fringes formed when monochromatic light passes through a diffraction grating.\n\nWhich of the following is/are correct?\n(1) $\\theta_3 = \\theta_2$\n(2) The maximum order of bright fringe is 4 if $\\theta_1 = 20^{\\circ}$.\n(3) $\\theta_3$ will decrease if the experiment is performed in water but not in air.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(3) only',
    explanation: 'The bright fringes from a diffraction grating are not equally spaced in angle, so $\\theta_3 \\neq \\theta_2$. From $d\\sin\\theta = n\\lambda$, if $\\theta_1 = 20^{\\circ}$ then the highest possible order is less than 3, not 4. In water, the wavelength decreases, so the diffraction angle also decreases.',
    difficulty: 2,
    sectionId: 'wave-nature-of-light',
    imagePaths: ['/physics/exercises/wave-nature-of-light/wol-068-question.png'],
    hints: ['Use $d\\sin\\theta = n\\lambda$.', 'In water, light wavelength decreases.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-001',
    question: 'Which of the following statements is/are correct?\n\n(1) Sound waves cannot be diffracted.\n(2) A louder sound travels faster in air.\n(3) Sound travels faster in water than in air.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(3) only',
    explanation: 'Sound waves can be diffracted because all waves can show diffraction. The speed of sound is independent of loudness and depends mainly on the medium. Sound travels faster in water than in air.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['All waves can diffract.', 'Sound speed depends on the medium, not the loudness.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-002',
    question: 'An ultrasonic wave is sent from a ship to find the depth of the sea-bed. A signal is received 0.2 s later. Given that the speed of sound in sea water is $1500 \\mathrm{~m} \\mathrm{~s}^{-1}$, what is the depth of the sea-bed?',
    options: ['75 m', '150 m', '300 m', '450 m'],
    answer: '150 m',
    explanation: 'The sound travels to the sea-bed and back, so the depth is half the total distance. Using $d = v\\Delta t / 2 = (1500)(0.2)/2$, the depth is $150\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['The echo time is for a round trip.', 'Divide by 2 at the end.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-003',
    question: 'Two sound waves of the same frequency are emitted from 2 sources $A$ and $B$ as shown in the diagram. What kind of interference will occur at the mid-point $P$ when the 2 waves generated are (1) in phase; (2) anti-phase?',
    options: [
      'In phase: constructive; Anti-phase: constructive',
      'In phase: constructive; Anti-phase: destructive',
      'In phase: destructive; Anti-phase: constructive',
      'In phase: cannot be determined; Anti-phase: cannot be determined'
    ],
    answer: 'In phase: constructive; Anti-phase: destructive',
    explanation: 'At the midpoint $P$, the path difference is zero. If the sources are in phase, zero path difference gives constructive interference. If the sources are anti-phase, zero path difference gives destructive interference.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-003-question.png'],
    hints: ['At the midpoint, the path difference is zero.', 'Phase difference then determines the result.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-004',
    question: 'Which of the following are longitudinal waves?\n\n(1) sound waves transmitted through a solid\n(2) sound waves transmitted through water\n(3) waves in a vibrating string',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(1) & (3) only'],
    answer: '(1) & (2) only',
    explanation: 'Sound waves in solids and in water are longitudinal waves. Waves on a vibrating string are transverse waves.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Sound in fluids is longitudinal.', 'A vibrating string supports transverse waves.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-005',
    question: 'Which of the following can be reflected and diffracted?\n\n(1) sound waves\n(2) infra-red radiation\n(3) X-rays',
    options: ['(1) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1), (2) & (3)',
    explanation: 'Sound waves, infra-red radiation and X-rays are all waves. As waves, all of them can show reflection and diffraction.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['All wave types can reflect and diffract.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-006',
    question: 'The depth of a lake can be found by the method of echo-sounding. The echo of a short pulse sent vertically down to the bottom of the lake was received after 0.6 s. Given that the speed of sound in water is $1440 \\mathrm{~m} \\mathrm{~s}^{-1}$, the depth of the lake will be',
    options: ['7.2 m', '14.4 m', '432 m', '864 m'],
    answer: '432 m',
    explanation: 'The sound travels to the bottom and back, so the depth is half the total distance travelled. Using $d = \\tfrac{1}{2}v\\Delta t = \\tfrac{1}{2}(1440)(0.6)$ gives $432\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Echo timing is for a round trip.', 'Use half of $v\\Delta t$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-007',
    question: 'The wavelength and velocity of a sound in air are 25 cm and $340 \\mathrm{~m} \\mathrm{~s}^{-1}$ respectively. When this sound enters a medium, its wavelength becomes 75 cm. Find the velocity of the sound in the medium.',
    options: ['$113 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$340 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$1020 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$1130 \\mathrm{~m} \\mathrm{~s}^{-1}$'],
    answer: '$1020 \\mathrm{~m} \\mathrm{~s}^{-1}$',
    explanation: 'The frequency does not change when sound enters another medium. Since $v=f\\lambda$, the speed is proportional to the wavelength. Thus $v_2 = 340 \\times \\dfrac{75}{25} = 1020\\,\\mathrm{m\\,s^{-1}}$.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Frequency stays the same across media.', 'Use the wavelength ratio.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-008',
    question: 'A signal of sound is sent vertically downwards from a ship. Its echo reflected from the sea bed is detected by a microphone on the ship 0.4 s later. What is the depth of the sea if the speed of sound in the sea is known to be $1500 \\mathrm{~m} \\mathrm{~s}^{-1}$?',
    options: ['150 m', '300 m', '600 m', '3000 m'],
    answer: '300 m',
    explanation: 'The sound travels to the sea bed and back, so the depth is half the total distance. Using $d = \\tfrac{1}{2}(1500)(0.4)$ gives $300\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['The 0.4 s is for the round trip.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-009',
    question: 'The range of sound that a boy can hear is from 30 Hz to 16500 Hz. If the speed of sound in air is $330 \\mathrm{~m} \\mathrm{~s}^{-1}$, what is the shortest wavelength of sound in air that the boy can hear?',
    options: ['0.02 m', '0.09 m', '11.0 m', '50.0 m'],
    answer: '0.02 m',
    explanation: 'The shortest wavelength corresponds to the greatest frequency. Using $v=f\\lambda$, $\\lambda = 330/16500 = 0.02\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Shortest wavelength comes from highest frequency.', 'Use $\\lambda = v/f$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-010',
    question: 'The wavelength and velocity of a sound in air are 25 cm and $330 \\mathrm{~m} \\mathrm{~s}^{-1}$ respectively. When this sound enters a medium, its wavelength becomes 75 cm. Find the velocity of the sound in the medium.',
    options: ['$165 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$330 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$660 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$990 \\mathrm{~m} \\mathrm{~s}^{-1}$'],
    answer: '$990 \\mathrm{~m} \\mathrm{~s}^{-1}$',
    explanation: 'The frequency does not change when sound enters another medium. Since $v=f\\lambda$, speed is proportional to wavelength. Thus $v_2 = 330 \\times \\dfrac{75}{25} = 990\\,\\mathrm{m\\,s^{-1}}$.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Frequency remains unchanged.', 'Use the wavelength ratio.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-011',
    question: 'Which of the following statements about sound is/are correct?\n\n(1) Sound cannot travel through water.\n(2) Loudness increases with the amplitude of the sound wave.\n(3) Pitch increases with the wavelength of the sound wave.',
    options: ['(1) only', '(2) only', '(1) & (3) only', '(2) & (3) only'],
    answer: '(2) only',
    explanation: 'Sound can travel through water. Loudness increases with amplitude. If wavelength increases in the same medium, frequency decreases, so pitch decreases rather than increases.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Pitch depends on frequency.', 'Loudness depends on amplitude.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-012',
    question: 'In the figure shown, the two loudspeakers $L_1$ and $L_2$ emit sound waves of wavelength 2 m. The waves emitted are exactly opposite in phase. Which of the following graphs best represents the variation of sound intensity $I$ along the line $XY$?',
    options: [
      '/physics/exercises/sound/snd-012-option-a.png',
      '/physics/exercises/sound/snd-012-option-b.png',
      '/physics/exercises/sound/snd-012-option-c.png',
      '/physics/exercises/sound/snd-012-option-d.png'
    ],
    answer: '/physics/exercises/sound/snd-012-option-c.png',
    explanation: 'Since the two sources are opposite in phase, the usual interference pattern is reversed. At the midpoint, the path difference is zero, so destructive interference occurs and the intensity is minimum. At a point where the path difference is $1\\,\\mathrm{m}=\\tfrac{1}{2}\\lambda$, constructive interference occurs, giving a maximum. This matches option C.',
    difficulty: 3,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-012-question.png'],
    hints: ['Opposite phase reverses the usual constructive/destructive positions.', 'Check the midpoint first.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-013',
    question: 'A bat emits sound waves of frequency 30 kHz and receives a reflected signal from an obstacle after 0.15 s. The speed of the sound in air is $340 \\mathrm{~m} \\mathrm{~s}^{-1}$. How far is the obstacle away from the bat?',
    options: ['11.3 m', '25.5 m', '51.0 m', '88.2 m'],
    answer: '25.5 m',
    explanation: 'The echo time is for the sound to travel to the obstacle and back. So the distance is $d = \\tfrac{1}{2}(340)(0.15) = 25.5\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Echo timing is a round trip.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-014',
    question: 'The diagrams above show the traces of two musical notes $X$ and $Y$ on an oscilloscope. Which of the following statements is/are true?\n\n(1) $X$ has a higher pitch than $Y$.\n(2) The loudness of $X$ is greater than that of $Y$.\n(3) $X$ and $Y$ are longitudinal waves.',
    options: ['(2) only', '(1) & (2) only', '(1) & (3) only', '(1), (2) & (3)'],
    answer: '(1), (2) & (3)',
    explanation: 'From the oscilloscope traces, $X$ has a shorter period, so it has a higher frequency and hence a higher pitch. $X$ also has greater amplitude, so it is louder. Both are sound waves, so they are longitudinal waves.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-014-question.png'],
    hints: ['Shorter period means higher pitch.', 'Greater amplitude means greater loudness.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-015',
    question: 'Which of the following is an application of ultrasonic in everyday life?',
    options: ['Cooking', 'TV broadcasting', 'Camera autofocusing', 'Satellite telecommunication'],
    answer: 'Camera autofocusing',
    explanation: 'Camera autofocusing can use ultrasonic waves or infra-red radiation. Cooking by microwave oven uses microwaves, TV broadcasting uses radio waves, and satellite telecommunication uses microwaves.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Ultrasonic is commonly used for ranging and sensing.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-016',
    question: 'Which of the following is/are longitudinal waves?\n\n(1) Ultrasonic transmitted through air.\n(2) Infrared transmitted through water.\n(3) Gamma rays transmitted through outer space.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) only',
    explanation: 'Ultrasonic is sound, so it is longitudinal in air. Infrared and gamma rays are electromagnetic waves, which are transverse.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Sound is longitudinal.', 'Electromagnetic waves are transverse.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-017',
    question: 'The frequencies of two musical notes $X$ and $Y$ are 256 Hz and 512 Hz respectively. If $X$ and $Y$ both have the same amplitude, which of the following statements is/are true?\n\n(1) $Y$ has a higher pitch than $X$.\n(2) The loudness of $X$ is larger than that of $Y$.\n(3) The wavelength of $Y$ is longer than that of $X$.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) only',
    explanation: 'Higher frequency means higher pitch, so $Y$ has a higher pitch. Since the amplitudes are the same, their loudness is the same. In the same medium, a higher frequency means a shorter wavelength, so $Y$ has a shorter wavelength, not a longer one.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Pitch depends on frequency.', 'Same amplitude means same loudness.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-018',
    question: 'Which of the following statements about ultrasonics is INCORRECT?',
    options: ['Ultrasonics are longitudinal waves.', 'The frequency of ultrasonics is above 20 kHz.', 'Ultrasonics are deflected by a magnetic field.', 'Ultrasonics cannot travel through a vacuum.'],
    answer: 'Ultrasonics are deflected by a magnetic field.',
    explanation: 'Ultrasonics are sound waves, so they are longitudinal and have frequencies above 20 kHz. Sound requires a material medium and cannot travel through vacuum. Sound waves are not deflected by a magnetic field.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Ultrasonic is sound, not a charged particle beam.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    ...
    options: ['Camera autofocusing', 'Satellite communication', 'Measurement of the depth of the sea-bed', 'Detection of cracks in railway tracks'],
    answer: 'Satellite communication',
    explanation: 'Satellite communication uses microwaves, not ultrasonics. The other three are common uses of ultrasonic waves.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Satellite communication uses electromagnetic waves.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-020',
    question: 'When a sound wave travels from air into water, its wavelength is increased by five times. If the speed of sound in air is $330 \\mathrm{~m} \\mathrm{~s}^{-1}$, find the speed of the sound wave in water.',
    options: ['$66 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$330 \\mathrm{~m} \\mathrm{~s}^{-1}$', '$1650 \\mathrm{~m} \\mathrm{~s}^{-1}$', 'insufficient information'],
    answer: '$1650 \\mathrm{~m} \\mathrm{~s}^{-1}$',
    explanation: 'The frequency does not change when sound enters another medium. Since $v=f\\lambda$, speed is proportional to wavelength. If wavelength becomes 5 times larger, the speed also becomes 5 times larger: $330 \\times 5 = 1650\\,\\mathrm{m\\,s^{-1}}$.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Frequency stays constant.', 'Use the wavelength ratio.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-021',
    question: 'Which of the following statements concerning microwaves and ultrasonic waves is/are correct?\n\n(1) Microwaves are electromagnetic waves while ultrasonic waves are not.\n(2) Microwaves and ultrasonic waves travel with the same speed in air.\n(3) Microwaves can be diffracted while ultrasonic waves cannot.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) only',
    explanation: 'Microwaves are electromagnetic waves, while ultrasonic waves are sound waves. They do not travel at the same speed in air. Both are waves, so both can be diffracted.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Microwaves travel at the speed of light in air.', 'All waves can diffract.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-022',
    question: 'Which of the following statements about ultrasonic waves is correct?',
    options: ['They are transverse waves.', 'They are electromagnetic waves.', 'They travel with a speed of $3 x 10^8 \\mathrm{~m} \\mathrm{~s}^{-1}$ in air.', 'They cannot travel through a vacuum.'],
    answer: 'They cannot travel through a vacuum.',
    explanation: 'Ultrasonic waves are sound waves, so they are longitudinal, not electromagnetic, and they travel at the speed of sound rather than the speed of light. Because sound needs a material medium, ultrasonics cannot travel through vacuum.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Ultrasonic is sound.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-023',
    question: 'Which of the following statements about light and sound is/are correct?\n\n(1) Both light and sound are transverse waves.\n(2) Both light and sound travel faster in air than in water.\n(3) Both light and sound can undergo refraction when travelling from one medium to another.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(3) only',
    explanation: 'Sound is longitudinal, not transverse. Light travels faster in air than in water, but sound travels faster in water than in air. Both are waves and can undergo refraction when they enter another medium.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Light and sound behave differently across media.', 'Both can refract.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-024',
    question: 'A microphone and a CRO are used to detect the sound emitted by two tuning forks $X$ and $Y$ in turn. The figures show the traces obtained, with the same setting of the CRO. Find the ratio of the frequency of the sounds emitted by $X$ to that of $Y$.',
    options: ['1:2', '2:1', '4:5', '5:4'],
    answer: '4:5',
    explanation: 'For the same time base on the CRO, the trace of $X$ completes 2 cycles while the trace of $Y$ completes 2.5 cycles. Therefore $f_X : f_Y = 2 : 2.5 = 4 : 5$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-024-question.png'],
    hints: ['Count cycles over the same time interval.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-025',
    question: 'A sonar on a ship is used to find the depth of the sea. An ultrasonic wave pulse is sent downwards from the ship towards the sea bed. The pulse travels with a speed of $1500 \\mathrm{~m} \\mathrm{~s}^{-1}$ in sea water. If the reflected pulse is received after 0.16 s, find the depth of the sea.',
    options: ['120 m', '240 m', '480 m', '4688 m'],
    answer: '120 m',
    explanation: 'The echo time is for a round trip, so the depth is $d = \\tfrac{1}{2}(1500)(0.16) = 120\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Echo timing is round-trip time.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    ...
    options: ['radio waves', 'visible light', 'X-rays', 'ultrasonic waves'],
    answer: 'ultrasonic waves',
    explanation: 'Radio waves, visible light and X-rays are electromagnetic waves, so they are transverse. Ultrasonic waves are sound waves, which are longitudinal.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Electromagnetic waves are transverse.', 'Ultrasonic is sound.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-027',
    question: 'The figures show the CRO displays of two musical notes $X$ and $Y$. The settings of the CRO for the two notes are identical. Which of the following statements are correct?\n\n(1) Notes $X$ and $Y$ are of different qualities.\n(2) Note $X$ is of a higher pitch than note $Y$.\n(3) Note $X$ is louder than note $Y$.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) & (3) only',
    explanation: 'Different waveforms indicate different quality (timbre). The two notes have the same period, so they have the same pitch. Note $X$ has the greater amplitude, so it is louder.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-027-question.png'],
    hints: ['Waveform shape shows quality.', 'Amplitude relates to loudness.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-028',
    question: 'The figure shows the image of a foetus (a baby not yet born) taken by a scanner. Which of the following waves should be used in the scanning process?',
    options: ['infra-red', 'microwaves', 'ultrasonics', 'X-rays'],
    answer: 'ultrasonics',
    explanation: 'Ultrasonic scanning is used to examine a foetus safely. X-rays are avoided because they can harm the foetus.',
    difficulty: 1,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-028-question.png'],
    hints: ['Medical foetal imaging commonly uses ultrasound.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-029',
    question: 'A ringing electric bell is placed inside a glass jar as shown. As air is pumped out of the jar, the sound will die away. Which of the following can explain this phenomenon?',
    options: ['The hammer of the bell cannot vibrate in a vacuum.', 'Sound waves are internally reflected by the glass surface.', 'Sound waves cannot travel in a vacuum.', 'The frequency of sound waves in a vacuum exceeds the audible frequency range.'],
    answer: 'Sound waves cannot travel in a vacuum.',
    explanation: 'As the air is removed, there is no material medium left to carry the sound wave, so the sound fades away.',
    difficulty: 1,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-029-question.png'],
    hints: ['Sound needs a material medium.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-030',
    question: 'Which of the following descriptions about microwaves and ultrasonic waves is correct?',
    options: ['They can both travel in a vacuum.', 'They are both transverse waves.', 'They can both be deflected by magnetic fields.', 'They travel with different speeds in air.'],
    answer: 'They travel with different speeds in air.',
    explanation: 'Microwaves are electromagnetic waves and travel at the speed of light in air. Ultrasonic waves are sound waves and travel at the speed of sound in air, so their speeds are different.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Microwaves and ultrasound are different kinds of waves.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-031',
    question: 'Two musical notes are produced by two different kinds of musical instruments. The two notes have the same pitch but different loudness. Which of the following combinations of notes satisfies the above description? Note: The settings of the CRO for displaying the notes are identical.',
    options: [
      '/physics/exercises/sound/snd-031-option-a.png',
      '/physics/exercises/sound/snd-031-option-b.png',
      '/physics/exercises/sound/snd-031-option-c.png',
      '/physics/exercises/sound/snd-031-option-d.png'
    ],
    answer: '/physics/exercises/sound/snd-031-option-d.png',
    explanation: 'The notes must have the same pitch, so they need the same period. They must have different loudness, so they need different amplitudes. Different instruments also give different waveforms, so option D is the correct match.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Same pitch means same frequency.', 'Different loudness means different amplitude.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-032',
    question: 'Which of the following is a unit of sound intensity level?',
    options: ['decibel', 'hertz', 'sievert', 'watt'],
    answer: 'decibel',
    explanation: 'Decibel (dB) is the unit used for sound intensity level. Hertz measures frequency, sievert measures radiation dose and watt measures power.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['dB is used for sound level.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-033',
    question: 'Which of the following statements about sound waves are correct?\n\n(1) Sound waves are longitudinal waves.\n(2) Sound waves are electromagnetic waves.\n(3) Sound waves cannot travel in a vacuum.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) & (3) only',
    explanation: 'Sound waves are mechanical longitudinal waves. They are not electromagnetic waves, and they cannot travel through a vacuum because they need a material medium.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Sound is mechanical, not electromagnetic.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-034',
    question: 'A loudspeaker is connected to a signal generator to produce sound waves. The frequency $f$ is varied and the corresponding wavelength $\\lambda$ is measured. The wavelength is plotted against the reciprocal of the frequency as shown above. Which of the following are correct deductions obtained from the graph?\n\n(1) The wavelength of the sound is inversely proportional to its frequency.\n(2) The slope of the graph is equal to the speed of the sound.\n(3) The speed of the sound depends on its frequency.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) & (2) only',
    explanation: 'A straight line through the origin on a plot of $\\lambda$ against $1/f$ shows that $\\lambda \\propto 1/f$. The slope is $\\lambda /(1/f)=f\\lambda=v$, so it gives the speed of sound. The constant slope shows the speed is independent of frequency.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-034-question.png'],
    hints: ['Use $v=f\\lambda$.', 'Interpret the graph slope carefully.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-035',
    question: 'The following data show the frequencies and sound intensity levels of some musical notes produced by a piano.\n\nNote C: 256 Hz, 64 dB\nNote D: 288 Hz, 68 dB\nNote E: 320 Hz, 65 dB\nNote F: 341 Hz, 63 dB\n\nWhich of the following statements is/are correct?\n\n(1) The note F has the lowest pitch.\n(2) The note D has the greatest loudness.\n(3) The note C played on a guitar will sound differently from the same note produced by the piano.',
    options: ['(1) only', '(2) only', '(1) & (3) only', '(2) & (3) only'],
    answer: '(2) & (3) only',
    explanation: 'Pitch depends on frequency, so note C, not F, has the lowest pitch. Loudness depends on intensity level, so note D is the loudest. The same note played by a different instrument has a different quality (timbre), so it sounds different.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-035-question.png'],
    hints: ['Pitch depends on frequency.', 'Loudness depends on sound intensity level.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-036',
    question: 'John and Tom communicate with each other by using two paper cups connected with a string. Which of the following statements are correct?\n\n(1) The sound waves transmitted along the string are transverse waves.\n(2) The speed of the sound waves along the string is faster than that in the air.\n(3) When John whistles a note of 1000 Hz towards the paper cup, Tom will also hear a note of 1000 Hz.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(2) & (3) only',
    explanation: 'Sound transmitted through the string is longitudinal, not transverse. Sound travels faster in solids than in air. The frequency does not change during transmission, so Tom hears 1000 Hz as well.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-036-question.png'],
    hints: ['Sound in a string is still longitudinal.', 'Frequency stays the same during transmission.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-037',
    question: 'Which of the following phenomena are due to the refraction of waves?\n\n(1) When water waves enter shallow water from deep water, the spacing between wavefronts decreases.\n(2) A swimming pool appears shallower than it actually is.\n(3) Mary can hear loud and soft sounds alternately when she walks across in front of two loudspeakers connected to a signal generator.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) & (2) only',
    explanation: 'Entering shallow water changes wave speed and wavelength, so that is refraction. Apparent depth is caused by refraction of light. Alternating loud and soft sounds in front of two loudspeakers are due to interference, not refraction.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Refraction involves a change of speed when entering another medium or region.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-038',
    question: 'Flash lamps used by professional photographers can find object distances by using infrared waves so as to adjust the flash output. Which of the following is/are the reason(s) of using infrared waves instead of ultrasonic waves in such flash lamps?\n\n(1) Speed of infrared waves is much faster than that of ultrasonic waves making the time for finding object distances shorter.\n(2) Objects to be photographed will usually emit infrared waves.\n(3) The sound produced by ultrasonic waves makes photographers feel annoyed.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) only',
    explanation: 'Infrared waves travel at the speed of light, much faster than ultrasonic waves, so distance measurement is quicker. Whether the object emits infrared is irrelevant because the lamp sends and detects its own reflected signal. Ultrasonic waves are not audible, so they do not annoy photographers.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Think about signal speed and the actual measurement method.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-039',
    question: 'Which of the following descriptions about ultrasonic waves must be correct?',
    options: ['In the same medium, the speed of the ultrasonic waves is higher than that of the audible sound waves.', 'In the same medium, the wavelength of the ultrasonic waves is longer than that of the audible sound waves.', 'In the same medium, the intensity of the ultrasonic waves is higher than that of the audible sound waves.', 'In the same medium, the frequency of the ultrasonic waves is higher than that of the audible sound waves.'],
    answer: 'In the same medium, the frequency of the ultrasonic waves is higher than that of the audible sound waves.',
    explanation: 'Ultrasonic waves are defined as sound waves with frequencies above the audible range, i.e. above 20 kHz. That is the only statement that must always be true.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Ultrasound is defined by its frequency.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-040',
    question: 'Two identical loudspeakers $X$ and $Y$ are connected in parallel to a signal generator. A microphone connected to a CRO detects a maximum when it is 0.2 m from $X$ and 0.4 m from $Y$. It detects a minimum when it is 0.9 m from $X$ and 0.4 m from $Y$. What is the possible wavelength of the sound wave?',
    options: ['0.1 m', '0.2 m', '0.4 m', '0.5 m'],
    answer: '0.2 m',
    explanation: 'At the maximum point, the path difference is $0.4-0.2=0.2\\,\\mathrm{m}$, so this must equal $n\\lambda$. At the minimum point, the path difference is $0.9-0.4=0.5\\,\\mathrm{m}$, so this must equal $(m+\\tfrac{1}{2})\\lambda$. Among the options, only $\\lambda=0.2\\,\\mathrm{m}$ satisfies both conditions.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Use path difference conditions for maxima and minima.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-041',
    question: 'Noise barriers built along highways are used to block the noise generated by road traffic. Which of the following statements correctly explain how the noise barriers can block the noise?\n\n(1) The noise from vehicles is reflected.\n(2) The noise is absorbed by the noise barriers.\n(3) The noise is diffracted at the top edge of the noise barriers.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1) & (2) only',
    explanation: 'Noise barriers reduce sound mainly by reflecting and absorbing the sound. Diffraction at the top edge allows sound to spread into the region behind the barrier, so it does not explain the blocking effect.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-041-question.png'],
    hints: ['Reflection and absorption reduce transmitted noise.', 'Diffraction works against blocking.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-042',
    question: 'A ship uses a sonar system to detect the depth of the sea. A sound wave signal of frequency 30000 Hz is sent vertically downward from the sea surface and the reflected signal is received 5 s later. Which of the following is correct? (The speed of sound wave in sea water is $1400 \\mathrm{~m} \\mathrm{~s}^{-1}$.)',
    options: [
      'Wavelength $4.67 x 10^{-2}$ m; Depth 3500 m',
      'Wavelength $4.67 x 10^{-2}$ m; Depth 7000 m',
      'Wavelength $9.33 x 10^{-2}$ m; Depth 3500 m',
      'Wavelength $9.33 x 10^{-2}$ m; Depth 7000 m'
    ],
    answer: 'Wavelength $4.67 x 10^{-2}$ m; Depth 3500 m',
    explanation: 'Using $v=f\\lambda$, the wavelength is $\\lambda=1400/30000=4.67\\times10^{-2}\\,\\mathrm{m}$. The 5 s is round-trip time, so the depth is $d=\\tfrac{1}{2}(1400)(5)=3500\\,\\mathrm{m}$.',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Use $v=f\\lambda$.', 'Echo timing is round-trip.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-043',
    question: 'In the figure, $S_1$ and $S_2$ are two identical loudspeakers connected in parallel to a signal generator. The circles represent the wavefronts of the sound wave produced. What are the changes to the loudness of the sound at $X$ and $Y$ if loudspeaker $S_1$ is turned off?',
    options: [
    ...
    answer: 'X increases; Y decreases',
    explanation: 'At $X$, the path difference is $0.5\\lambda$, so destructive interference makes the sound weak. If $S_1$ is turned off, the destructive interference disappears and the loudness increases. At $Y$, the path difference is $0\\lambda$, so constructive interference makes the sound strong. If $S_1$ is turned off, the constructive interference disappears and the loudness decreases.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-043-question.png'],
    hints: ['Identify whether each point is constructive or destructive initially.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-044',
    question: 'Sound waves of 660 Hz are produced from two identical loudspeakers $S_1$ and $S_2$ which are connected in parallel to a signal generator. The distances $S_1X$ and $S_2X$ are 2 m and 4 m respectively. $O$ is the midpoint of $S_1S_2$. What kinds of interference occur at $X$ and $Y$ respectively? Given that the speed of sound in air is $330 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    options: [
      'X constructive; Y constructive',
      'X constructive; Y destructive',
      'X destructive; Y constructive',
      'X destructive; Y destructive'
    ],
    answer: 'X constructive; Y constructive',
    explanation: 'The wavelength is $\\lambda = 330/660 = 0.5\\,\\mathrm{m}$. At $X$, the path difference is $4-2=2\\,\\mathrm{m}=4\\lambda$, so the interference is constructive. At $Y$, the path difference is zero, so the interference is also constructive.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-044-question.png'],
    hints: ['First find the wavelength from $v=f\\lambda$.', 'Then compare path difference with $\\lambda$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-045',
    question: 'Which of the following statements about sound waves is not correct?',
    options: ['Sound waves are longitudinal waves.', 'Sound waves diffract when travelling through a doorway.', 'Sound waves cannot pass through a vacuum.', 'All sound waves of frequencies above 20 Hz are audible.'],
    answer: 'All sound waves of frequencies above 20 Hz are audible.',
    explanation: 'The audible range is about 20 Hz to 20000 Hz. Frequencies above 20000 Hz are ultrasonic and are not audible to humans.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Remember the audible frequency range.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-046',
    question: 'In the figure, a firecracker at a position 80 m away from a building explodes and produces a bang. A girl standing 90 m away from the firecracker hears two bangs. What is the time interval between the two bangs? Given: speed of sound in air $=340 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    options: ['0.24 s', '0.26 s', '0.47 s', '0.50 s'],
    answer: '0.47 s',
    explanation: 'The direct sound takes $t_1=90/340=0.265\\,\\mathrm{s}$. The reflected sound travels $80+80+90=250\\,\\mathrm{m}$, so $t_2=250/340=0.735\\,\\mathrm{s}$. The interval is $0.735-0.265=0.47\\,\\mathrm{s}$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-046-question.png'],
    hints: ['One bang is direct, the other is reflected.', 'Compare the two travel times.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-047',
    question: 'The figure shows a sound wave travelling in water. It is known that sound waves travel faster in water than in air. After refraction, which of the following statements is/are correct?\n\n(1) The wavelength of the sound wave increases.\n(2) The frequency of the sound wave remains unchanged.\n(3) The sound wave bends away from the normal.',
    options: ['(1) only', '(2) only', '(1) & (3) only', '(2) & (3) only'],
    answer: '(2) only',
    explanation: 'When sound goes from water to air, its speed decreases, so its wavelength decreases as well. The frequency remains unchanged during refraction. Since the speed in air is lower, the wave bends towards the normal, not away from it.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-047-question.png'],
    hints: ['Frequency is unchanged during refraction.', 'Lower speed means bending towards the normal.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-048',
    question: 'Two identical loudspeakers are connected in parallel to a signal generator, $O$ is the midpoint between the loudspeakers. When a sound intensity level meter is moved from $P$ to $Q$, the graph below shows the variation of the sound intensity level received with position. Which of the following statements is/are correct?\n\n(1) The sound intensity level at $Q$ is smaller because the amplitude of the sound wave decreases as it is further away from the loudspeakers.\n(2) Constructive interference occurs at point $P$ while destructive interference occurs at point $Q$.\n(3) The result of the experiment shows that sound is a wave.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) only',
    explanation: 'The lower sound intensity at $Q$ is explained by the reduced intensity with distance. The path difference at $Q$ is zero, so $Q$ is constructive, not destructive. This graph alone shows intensity change with position, but it does not by itself demonstrate interference clearly enough to prove wave behaviour.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: [
      '/physics/exercises/sound/snd-048-question.png',
      '/physics/exercises/sound/snd-048-question-2.png'
    ],
    hints: ['Check what happens at the midpoint.', 'Separate distance effect from interference effect.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-049',
    question: 'Two tuning forks $F_1$ and $F_2$ are hit respectively to give sound notes. Their waveforms are displayed on a CRO connected to a microphone. The traces $S_1$ and $S_2$ observed on the screen of the CRO are given by $F_1$ and $F_2$ respectively. The time base of the CRO remains the same in each case. Which of the following statements is/are correct?\n\n(1) The period of $F_1$ is greater than the period of $F_2$.\n(2) The pitch of $F_1$ is greater than the pitch of $F_2$.\n(3) The speed of sound from $F_1$ is greater than the speed of sound from $F_2$.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) only',
    explanation: 'From the CRO traces, $F_1$ takes a longer time to complete one cycle, so its period is greater. That means its frequency and pitch are lower, not higher. Both are sound waves travelling in air, so they have the same speed.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-049-question.png'],
    hints: ['Use the same CRO time base to compare periods.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-050',
    question: 'A beam of ultrasound is directed from water to air as shown in the above figure. Which of the following statements is true?',
    options: ['The refracted beam leaving the surface will bend away from the normal.', 'The refracted beam will bend towards the normal.', 'The refracted beam will travel in the same direction as the incident beam.', 'Total internal reflection will occur.'],
    answer: 'The refracted beam will bend towards the normal.',
    explanation: 'Ultrasound travels faster in water than in air. When it enters air, its speed decreases, so it bends towards the normal.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-050-question.png'],
    hints: ['Lower wave speed after refraction means bending towards the normal.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-051',
    question: 'Which of the following represent the approximate noise levels (1) in a quiet school library and (2) near the road with heavy traffic?',
    options: ['(1) 30 dB, (2) 60 dB', '(1) 60 dB, (2) 90 dB', '(1) 30 dB, (2) 90 dB', '(1) 90 dB, (2) 60 dB'],
    answer: '(1) 30 dB, (2) 90 dB',
    explanation: 'A quiet school library is typically around 30 to 40 dB, while a busy road with heavy traffic is typically around 90 to 100 dB.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Library is quiet; heavy traffic is loud.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-052',
    question: 'Two loudspeakers are connected to the same signal generator. A microphone placed at $X$ detects a maximum sound intensity. When the microphone is moved upwards, maximum sound intensity is also detected at $Y$. Which of the following may give possible values of the wavelength of the sound emitted from the loudspeakers?\n\n(1) 0.04 m\n(2) 0.08 m\n(3) 0.16 m',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(1) & (2) only',
    explanation: 'The path difference is $3.30-3.22=0.08\\,\\mathrm{m}$. For a maximum, the path difference must be an integer multiple of the wavelength. So $\\lambda=0.04\\,\\mathrm{m}$ gives $2\\lambda$, and $\\lambda=0.08\\,\\mathrm{m}$ gives $1\\lambda$. But $\\lambda=0.16\\,\\mathrm{m}$ gives $0.5\\lambda$, which would be destructive.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-052-question.png'],
    hints: ['Constructive interference requires path difference $=n\\lambda$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-053',
    question: 'Two loudspeakers $S_1$ and $S_2$ are connected to a signal generator to give out sound waves that are in phase. The separation between $S_1$ and $S_2$ is 0.8 m. A student moves a microphone along a line $PP\\prime$ 8.0 m away from the loudspeakers and parallel to $S_1S_2$. Loud sound is detected consecutively at $P$, $O$ and $P\\prime$. If $PP\\prime$ equals 2.0 m, estimate the wavelength of the sound produced by the loudspeakers.',
    options: ['5 cm', '10 cm', '15 cm', '20 cm'],
    answer: '10 cm',
    explanation: 'At $P$, the path lengths are $S_1P=\\sqrt{8^2+0.6^2}=8.022\\,\\mathrm{m}$ and $S_2P=\\sqrt{8^2+1.4^2}=8.122\\,\\mathrm{m}$. The path difference is about $0.1\\,\\mathrm{m}$. Since $P$ is the first maximum from the central maximum at $O$, this path difference equals $1\\lambda$. So $\\lambda=0.1\\,\\mathrm{m}=10\\,\\mathrm{cm}$.',
    difficulty: 3,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-053-question.png'],
    hints: ['Use geometry to estimate the path difference at the first side maximum.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-054',
    question: 'Sound waves of frequency 1000 Hz travel from air to water as shown. If the incident wavefront makes an angle of $13^\\circ$ with the interface, find the angle of refraction and the wavelength of sound in water. (Given: speed of sound in air and that in water are $340 \\mathrm{~m} \\mathrm{~s}^{-1}$ and $1500 \\mathrm{~m} \\mathrm{~s}^{-1}$ respectively.)',
    options: [
      'Angle of refraction $2.9^\\circ$; wavelength in water 7.7 cm',
      'Angle of refraction $2.9^\\circ$; wavelength in water 1.5 m',
      'Angle of refraction $83^\\circ$; wavelength in water 7.7 cm',
      'Angle of refraction $83^\\circ$; wavelength in water 1.5 m'
    ],
    answer: 'Angle of refraction $83^\\circ$; wavelength in water 1.5 m',
    explanation: 'Using wave refraction, $\\sin 13^\\circ/\\sin \\theta = 340/1500$, so the refracted wavefront angle is $\\theta\\approx 83^\\circ$. In water, $v=f\\lambda$, so $1500=(1000)\\lambda$ and $\\lambda=1.5\\,\\mathrm{m}$.',
    difficulty: 3,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-054-question.png'],
    hints: ['Use the wavefront-angle form of refraction.', 'Then use $v=f\\lambda$.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-055',
    question: 'The above figure shows a speed detector used for measuring the speed of a toy car. The detector emits an ultrasound pulse $P_1$ towards the car, which is reflected back to the detector as pulse $R_1$ after 15 ms. Another pulse $P_2$ is emitted 0.5 s after $P_1$ is emitted and the reflected pulse $R_2$ is received 20 ms later.\n\nAssume that the car is travelling directly away from the detector with uniform speed. Estimate its speed. Given: speed of ultrasound in air $=340 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    options: ['1.7 m s^-1', '2.1 m s^-1', '2.6 m s^-1', '3.4 m s^-1'],
    answer: '1.7 m s^-1',
    explanation: 'The first distance is $d_1=\\tfrac{1}{2}(340)(15\\times10^{-3})=2.55\\,\\mathrm{m}$. The second distance is $d_2=\\tfrac{1}{2}(340)(20\\times10^{-3})=3.4\\,\\mathrm{m}$. The car moves $3.4-2.55=0.85\\,\\mathrm{m}$ in 0.5 s, so its speed is $0.85/0.5=1.7\\,\\mathrm{m\\,s^{-1}}$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: [
      '/physics/exercises/sound/snd-055-question.png',
      '/physics/exercises/sound/snd-055-question-2.png'
    ],
    hints: ['Each echo time is round-trip.', 'Compare the two measured distances.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-056',
    question: 'Two loudspeakers are connected to a signal generator and they give out sound waves in anti-phase. A small microphone is placed midway between the two loudspeakers. The intensity of the sound detected by the microphone is close to zero. Which of the following changes can lead to a significant increase in the sound intensity detected?\n\n(1) Move the microphone along the $x$ direction.\n(2) Move the microphone along the $y$ direction.\n(3) Increase the frequency of the signal generator.',
    options: ['(1) only', '(2) only', '(1) & (3) only', '(2) & (3) only'],
    answer: '(1) only',
    explanation: 'At the midpoint, the path difference is zero, so anti-phase sources give destructive interference. Moving along the $x$ direction changes the path difference and can remove the cancellation. Moving along the $y$ direction keeps the path difference at zero. Changing frequency alone does not help because the midpoint still has zero path difference for anti-phase sources.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-056-question.png'],
    hints: ['At the midpoint, anti-phase sources cancel.', 'Path difference matters.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-057',
    question: 'A boy claps his hands in front of a cliff at the position $X$ as shown in the above figure. He hears the echo 0.8 s later. He then walks a distance $d$ towards the cliff and claps again at the position $Y$. This time he hears the echo 0.6 s later. Find $d$ if the speed of sound in air is $330 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    options: ['17 m', '33 m', '66 m', '132 m'],
    answer: '33 m',
    explanation: 'The echo time decreases by $0.8-0.6=0.2\\,\\mathrm{s}$. Since this is round-trip sound travel, the distance moved is $d=\\tfrac{1}{2}(330)(0.2)=33\\,\\mathrm{m}$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-057-question.png'],
    hints: ['Echo timing is round-trip.', 'Use the change in echo time.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-058',
    question: 'What is the approximate range of audible frequencies for a young adult?',
    options: ['from 2 Hz to 2000 Hz', 'from 20 Hz to 2000 Hz', 'from 20 Hz to 20000 Hz', 'from 200 Hz to 200000 Hz'],
    answer: 'from 20 Hz to 20000 Hz',
    explanation: 'The normal audible frequency range for a young adult is approximately 20 Hz to 20000 Hz.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Remember the standard human audible range.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-059',
    question: 'Which factors affect the quality of sound waves produced by a musical instrument?',
    options: ['the amplitude of the sound waves', 'the frequency of the sound waves', 'the velocity of the sound waves', 'the waveform of the sound waves'],
    answer: 'the waveform of the sound waves',
    explanation: 'The quality (timbre) of a sound is determined by its waveform, not by amplitude, frequency or wave speed.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Quality means timbre.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-060',
    question: 'Two boys both sing the same musical note "doh". However, the two notes can be distinguished to be sung by which boy since they have different',
    options: ['speed', 'loudness', 'pitch', 'quality'],
    answer: 'quality',
    explanation: 'If they sing the same note, the pitch is the same. They can still be distinguished by the quality (timbre) of the sound.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Same note means same pitch.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-061',
    question: 'Mary stands between two cliffs $A$ and $B$ as shown in the above figure. She claps her hands and hears the first echo after 1.2 s and the second echo after 1.8 s. If the speed of sound in air is $320 \\mathrm{~m} \\mathrm{~s}^{-1}$, what is the distance $d$ between the two cliffs?',
    options: ['192 m', '288 m', '480 m', '960 m'],
    answer: '480 m',
    explanation: 'The first echo gives the distance to cliff $A$: $d_1=\\tfrac{1}{2}(320)(1.2)=192\\,\\mathrm{m}$. The second echo gives the distance to cliff $B$: $d_2=\\tfrac{1}{2}(320)(1.8)=288\\,\\mathrm{m}$. So the distance between the cliffs is $192+288=480\\,\\mathrm{m}$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-061-question.png'],
    hints: ['Each echo time gives a one-way distance after dividing by 2.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-062',
    question: 'Peter sees a flash of lightning in the sky. After 6 s, he hears the bang of thunder. How far away is he from the thunderstorm? (Given: speed of light in air $=3 \\times 10^8 \\mathrm{~m} \\mathrm{~s}^{-1}$; speed of sound in air $=320 \\mathrm{~m} \\mathrm{~s}^{-1}$.)',
    options: ['960 m', '1920 m', '$9 x 10^8$ m', '$18 x 10^8$ m'],
    answer: '1920 m',
    explanation: 'The time for light to reach Peter is negligible compared with 6 s. So the distance is found using the sound travel: $d=(320)(6)=1920\\,\\mathrm{m}$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Ignore the light travel time compared with the sound travel time.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-063',
    question: 'Arrange the following in ascending order of frequency:\n\n(1) the domestic mains voltage\n(2) microwaves from a mobile phone\n(3) a note of sound from a violin',
    options: ['(1) (2) (3)', '(1) (3) (2)', '(2) (1) (3)', '(3) (2) (1)'],
    answer: '(1) (3) (2)',
    explanation: 'Domestic mains is about 50 Hz. A violin note is around $10^3$ Hz. Microwaves from a mobile phone are around $10^{10}$ Hz. So the ascending order is (1), (3), (2).',
    difficulty: 2,
    sectionId: 'sound',
    hints: ['Compare the orders of magnitude of the three frequencies.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-064',
    question: 'Which of the following statements about sound waves is/are correct?\n\n(1) Sound waves are longitudinal waves.\n(2) Sound waves are electromagnetic waves.\n(3) Sound waves cannot travel in a vacuum.',
    options: ['(2) only', '(3) only', '(1) & (2) only', '(1) & (3) only'],
    answer: '(1) & (3) only',
    explanation: 'Sound waves are mechanical longitudinal waves. They are not electromagnetic waves, and they cannot travel in a vacuum because they need a material medium.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Sound is mechanical, not electromagnetic.', 'Sound needs a medium.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-065',
    question: 'The figure shows the waveforms of sound notes generated by a violin, a piano and a tuning fork. The scale is the same in time and intensity axes for all three waveforms. Which of the following about the sound notes are correct?\n\n(1) They all have the same pitch.\n(2) The qualities of sound of (Y) and (Z) are different.\n(3) (X) is generated by the tuning fork.',
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(1), (2) & (3)',
    explanation: 'They have the same number of cycles over the same time interval, so they have the same frequency and pitch. Different waveforms mean different qualities. A tuning fork produces a nearly pure sinusoidal waveform, so (X) is the tuning fork.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-065-question.png'],
    hints: ['Same frequency means same pitch.', 'Waveform shape shows quality.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-066',
    question: 'Which of the following about ultrasound is INCORRECT?',
    options: ['Ultrasound is a longitudinal wave.', 'The frequency of ultrasound is greater than 20000 Hz.', 'In air, the speed of ultrasound is faster than the speed of audible sound.', 'In air, the diffraction effect of ultrasound is less prominent than that of audible sound.'],
    answer: 'In air, the speed of ultrasound is faster than the speed of audible sound.',
    explanation: 'In the same medium, ultrasound and audible sound travel at the same speed. The higher frequency of ultrasound means a shorter wavelength, so its diffraction is less prominent.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Sound speed in one medium does not depend on frequency.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-067',
    question: 'Astronauts $P$ and $Q$ stand at 400 m and 600 m respectively from a vertical cliff on the surface of a planet. The figure shows the top view. $P$ claps his hands once and $Q$ hears two clapping sounds separated by 4 s. What is the speed of sound in the atmosphere of this planet?',
    options: ['100 m s^-1', '150 m s^-1', '200 m s^-1', '250 m s^-1'],
    answer: '200 m s^-1',
    explanation: 'The first sound reaches $Q$ directly. The second is reflected by the cliff. The extra distance for the reflected sound is twice the distance from $P$ to the cliff, i.e. $2(400)=800\\,\\mathrm{m}$. Since the time difference is 4 s, the speed is $800/4=200\\,\\mathrm{m\\,s^{-1}}$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-067-question.png'],
    hints: ['Use the extra reflected path, not the full direct path.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-068',
    question: '$S_1$ and $S_2$ are two loudspeakers connected to a signal generator but the sound waves produced by them are in anti-phase. Point $O$ is equidistant from the loudspeakers while point $P$ is at the distances shown in the figure from the loudspeakers. What type of interference occurs at $O$ and $P$ if the wavelength of the sound waves is 10 cm?',
    options: [
      'O destructive; P constructive',
      'O constructive; P constructive',
      'O destructive; P destructive',
      'O constructive; P destructive'
    ],
    answer: 'O destructive; P destructive',
    explanation: 'At $O$, the path difference is zero. Since the sources are in anti-phase, zero path difference gives destructive interference. At $P$, the path difference is $3.0-2.8=0.2\\,\\mathrm{m}=20\\,\\mathrm{cm}=2\\lambda$. An integer multiple of $\\lambda$ keeps the anti-phase condition, so the interference at $P$ is also destructive.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-068-question.png'],
    hints: ['Anti-phase sources reverse the usual interference condition.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-069',
    question: 'Figure (a) shows a car travelling with a uniform speed along a straight road away from a stationary ultrasound generator and detector at $Y$. When the car is 64 m from $Y$, the generator emits an ultrasound pulse towards the car. The pulse is then reflected back to the detector at $Y$ and displayed on a CRO as shown in Figure (b). Estimate the speed of the car. Given: speed of ultrasound in air is $340 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    options: ['16 m s^-1', '20 m s^-1', '24 m s^-1', '32 m s^-1'],
    answer: '20 m s^-1',
    explanation: 'From the CRO, the pulse is emitted at 0.1 s and received at 0.5 s, so the round-trip time is 0.4 s. The one-way travel time is 0.2 s. In that time, sound travels $(340)(0.2)=68\\,\\mathrm{m}$, so the car has moved from 64 m to 68 m, i.e. 4 m in 0.2 s. The car speed is $4/0.2=20\\,\\mathrm{m\\,s^{-1}}$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-069-question.png'],
    hints: ['Read the pulse timing from the CRO first.', 'Use one-way travel time.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    ...
    options: ['(2) only', '(3) only', '(1) & (2) only', '(1) & (3) only'],
    answer: '(2) only',
    explanation: 'Sound waves are mechanical, not electromagnetic. They need a material medium, so they cannot travel in a vacuum. Sound waves can form stationary waves, so statement (3) is false.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['All waves can form stationary waves under suitable conditions.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-071',
    question: 'A balloon is rising at a uniform speed of $20 \\mathrm{~m} \\mathrm{~s}^{-1}$. When the balloon is at an altitude $H$ as shown, it sends a sound signal towards the ground. After 5 s, the balloon receives the echo of the signal. Estimate $H$. Given: speed of sound in air $=340 \\mathrm{~m} \\mathrm{~s}^{-1}$.',
    options: ['1600 m', '850 m', '800 m', '750 m'],
    answer: '800 m',
    explanation: 'During the 5 s, the balloon rises by $(20)(5)=100\\,\\mathrm{m}$. The sound travels down to the ground and then back up to the higher balloon, so the total sound path is $H+H+100=2H+100$. Since the sound speed is 340 m s^-1, $(340)(5)=1700=2H+100$, so $H=800\\,\\mathrm{m}$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-071-question.png'],
    hints: ['The balloon has moved upward before the echo returns.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-072',
    question: 'Loudspeakers $S_1$ and $S_2$ connected to a signal generator emit sound waves which are in phase. Point $O$ is equidistant from the loudspeakers while at point $P$ maximum loudness is detected. The wavelength of the sound waves is $\\lambda$. Which statement is INCORRECT?',
    options: [
      'Both $PS_1$ and $PS_2$ must be integral multiples of wavelength $\\lambda$.',
      'The definite value of the path difference $PS_2-PS_1$ cannot be determined from the information given.',
      'At least one point of minimum loudness can be detected between $O$ and $P$.',
      'Minimum loudness will be detected at $P$ if the sound waves from $S_1$ and $S_2$ are in antiphase.'
    ],
    answer: 'Both $PS_1$ and $PS_2$ must be integral multiples of wavelength $\\lambda$.',
    explanation: 'For constructive interference, only the path difference must be an integer multiple of $\\lambda$. The individual distances $PS_1$ and $PS_2$ do not each need to be integer multiples of $\\lambda$.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-072-question.png'],
    hints: ['Constructive interference depends on path difference, not the individual path lengths.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    ...
    options: ['(1) & (2) only', '(1) & (3) only', '(2) & (3) only', '(1), (2) & (3)'],
    answer: '(2) & (3) only',
    explanation: 'Ultrasound is used for non-destructive testing such as detecting cracks in railway tracks, and it is also used medically to break up kidney stones. Sterilizing drinking water is done using ultraviolet radiation, not ultrasound.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Sterilization of water is UV, not ultrasound.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-074',
    question: 'An experiment is set up to measure the speed of sound in air as shown. $P$ and $Q$ are two microphones connected to a timer. A sound is produced at $X$. The timer starts when $P$ receives the sound, and stops when $Q$ receives the sound. The timer shows the time taken for the sound to travel from $P$ to $Q$. The distance $PQ$ and the time shown can be used to calculate the speed of sound. Which of the following statements is INCORRECT?',
    options: [
      '$X$, $P$ and $Q$ must be along the same straight line.',
      'The percentage error in the time measured will increase if the distance $PQ$ is reduced.',
      'The speed of sound determined should be independent of the distance between $X$ and $P$.',
      'The distance $PQ$ must be equal to an integral multiple of wavelengths of the sound produced at $X$.'
    ],
    answer: 'The distance $PQ$ must be equal to an integral multiple of wavelengths of the sound produced at $X$.',
    explanation: 'The microphones just measure travel time between two points, so $PQ$ can be any convenient distance. It does not need to be an integer multiple of the wavelength.',
    difficulty: 2,
    sectionId: 'sound',
    imagePaths: ['/physics/exercises/sound/snd-074-question.png'],
    hints: ['This is a timing experiment, not an interference experiment.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-075',
    question: 'Two musical notes of the same pitch and loudness are produced by two different musical instruments. They sound different to the human ears because they have different',
    options: ['amplitudes', 'phases', 'wave speeds', 'waveforms'],
    answer: 'waveforms',
    explanation: 'Different instruments producing notes with the same pitch and loudness can still sound different because their waveforms are different. This difference in waveform gives a different quality (timbre).',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Different waveform means different quality.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-076',
    question: 'If the speed of sound in water is $x$ and the speed of light in water is $y$, which of the following is correct?',
    options: [
      'speed of sound in air $>x$; speed of light in air $>y$',
      'speed of sound in air $>x$; speed of light in air $<y$',
      'speed of sound in air $<x$; speed of light in air $>y$',
      'speed of sound in air $<x$; speed of light in air $<y$'
    ],
    answer: 'speed of sound in air $<x$; speed of light in air $>y$',
    explanation: 'Sound travels faster in water than in air, so the speed of sound in air is less than $x$. Light travels faster in air than in water, so the speed of light in air is greater than $y$.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Sound and light behave oppositely when comparing air and water.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-077',
    question: 'Which of the following is NOT a typical sound intensity level that occurs in daily life?',
    options: ['130 dB: when an airplane takes off', '110 dB: at a rock concert', '80 dB: having a normal conversation', '30 dB: inside a library'],
    answer: '80 dB: having a normal conversation',
    explanation: 'A normal conversation is usually around 60 dB, not 80 dB. The other listed values are reasonable daily-life examples.',
    difficulty: 1,
    sectionId: 'sound',
    hints: ['Normal conversation is around 60 dB.'],
    type: 'multiple_choice',
    points: 15
  },
  {
    id: 'snd-078',
    question: 'Which of the following statements about waves is/are correct?\n\n(1) Longitudinal waves can transmit energy from one place to another but transverse waves cannot.\n(2) Sound waves propagate faster in water than in air.\n(3) Infra-red radiation is a kind of electromagnetic wave.',
    options: ['(1) only', '(3) only', '(1) & (2) only', '(2) & (3) only'],
    answer: '(2) & (3) only',
    explanation: 'Both longitudinal and transverse waves can transmit energy, so statement (1) is false. Sound travels faster in water than in air, and infra-red radiation is an electromagnetic wave.',
    difficulty: 1,
    sectionId: 'sound',
