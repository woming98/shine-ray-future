          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              <div className="relative">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-400 to-accent-500 flex items-center justify-center shadow-lg group-hover:shadow-primary-500/50 transition-shadow">
                  <span className="text-white font-bold text-lg">莘</span>
                </div>
                <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 rounded-full border-2 border-navy-950 animate-pulse" />
              </div>
          ...
          <div className="hidden md:flex flex-1 max-w-xl mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all"
              />
            ...
            <div className="relative">
              ...
              >
                <div className="hidden sm:flex flex-col items-end">
                  ...
                  <span className="text-primary-400 text-xs">Lv.{user?.level || 1}</span>
                </div>
