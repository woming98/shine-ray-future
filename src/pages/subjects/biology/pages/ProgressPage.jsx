      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="card-bio text-center">
            ...
            <div className="text-gray-700 text-sm">完成率</div>
          </div>
          ...
          <div className="card-bio text-center">
            ...
            <div className="text-gray-700 text-sm">閃卡已複習</div>
          </div>
          ...
          <div className="card-bio text-center">
            ...
            <div className="text-gray-700 text-sm">學習分鐘</div>
          </div>
          ...
          <div className="card-bio text-center">
            ...
            <div className="text-gray-700 text-sm">模組完成</div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="card-bio"
          >
            <h3 className="font-display font-bold text-xl text-green-900 mb-6 flex items-center gap-2">
            ...
            <div className="relative h-48 mb-4">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="font-display font-bold text-4xl text-green-600">
                    {completionRate}%
                  </div>
                  <div className="text-gray-700 text-sm">完成</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-green-900 font-medium">{completedModules}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="flex items-center gap-2 text-gray-700">
                ...
                <span className="text-green-900 font-medium">{totalModules - completedModules}</span>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <h3 className="font-display font-bold text-xl text-green-900 mb-6">
            📚 主題詳情
          </h3>
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-display font-bold text-green-900">
                        {topic.titleCn}
                      </h4>
                      <p className="text-gray-700 text-sm">{topic.title}</p>
                    </div>
        ...
        >
          <div className="card-bio">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-display font-bold text-green-900">最近學習</h3>
            </div>
            <p className="text-gray-700">{lastStudyDate}</p>
          </div>
          ...
          <div className="card-bio">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-display font-bold text-green-900">重置進度</h3>
              </div>
              <button
                onClick={() => {
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className={`card-bio text-center ${completedModules >= 1 ? '' : 'opacity-40'}`}>
              ...
              <h4 className="font-display font-bold text-green-900">初學者</h4>
              <p className="text-gray-700 text-sm">完成第一個模組</p>
            </div>
            
            <div className={`card-bio text-center ${progress.flashcardsReviewed >= 10 ? '' : 'opacity-40'}`}>
              <div className="text-4xl mb-2">📚</div>
              <h4 className="font-display font-bold text-green-900">閃卡達人</h4>
              <p className="text-gray-700 text-sm">複習10張閃卡</p>
            </div>
            
            <div className={`card-bio text-center ${completionRate >= 50 ? '' : 'opacity-40'}`}>
              <div className="text-4xl mb-2">🔬</div>
              <h4 className="font-display font-bold text-green-900">生物學家</h4>
              <p className="text-gray-700 text-sm">完成50%進度</p>
            </div>
            
            <div className={`card-bio text-center ${completionRate >= 100 ? '' : 'opacity-40'}`}>
              <div className="text-4xl mb-2">🧬</div>
              <h4 className="font-display font-bold text-green-900">DSE大師</h4>
              <p className="text-gray-700 text-sm">完成所有模組</p>
            </div>
          </div>
        </motion.div>
      </div>
