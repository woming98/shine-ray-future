...
export function Card({ children, className = '', hover = true, gradient, onClick }: CardProps) {
  const baseClasses = 'bg-white rounded-2xl p-6 border border-emerald-200/50 shadow-sm';
  const hoverClasses = hover ? 'hover:shadow-md hover:border-emerald-300 transition-all duration-200' : '';
