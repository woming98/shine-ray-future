...
export const s1VocabularyQuestions: VocabularyQuestion[] = [
  // ========== Unit vocab (context) ==========
  // 说明：以下为原创的中一插班常见词汇（配合 Grammar & Vocab 部分的学习建议）。
  {
    id: 'v1-unit-001',
    grade: 'S1',
    type: 'context',
    ...
    word: 'worry',
    options: ['worry', 'predict', 'comfort', 'caring'],
    answer: 'worry',
    explanation: 'worry about + n./V-ing = 担心…',
    difficulty: 'easy',
  },
  {
    id: 'v1-unit-002',
    grade: 'S1',
    type: 'context',
    question: 'Choose the best word to complete the sentence: "It is hard to ____ what will happen next."',
    word: 'predict',
    options: ['predict', 'worry', 'moved', 'upset'],
    answer: 'predict',
    explanation: 'predict = 预测；predict + clause。',
    difficulty: 'easy',
  },
  {
    id: 'v1-unit-003',
    grade: 'S1',
    type: 'context',
    question: 'Choose the best word to complete the sentence: "His father tried to ____ him after the bad news."',
    word: 'comfort',
    options: ['comfort', 'predict', 'upset', 'fortune-teller'],
    answer: 'comfort',
  ...
  },
  {
    ...
    grade: 'S1',
    type: 'meaning',
    question: 'What does "fortune-teller" mean?',
    word: 'fortune-teller',
    options: ['a person who tells jokes', 'a person who predicts the future', 'a person who sells food', 'a person who fixes cars'],
    answer: 'a person who predicts the future',
    explanation: 'fortune-teller = 算命先生 / 占卜师。',
    difficulty: 'easy',
  },
  {
    id: 'v1-unit-005',
    grade: 'S1',
    type: 'meaning',
    question: 'Choose the best meaning of "upset":',
    word: 'upset',
    options: ['very happy', 'angry or sad', 'very sleepy', 'very hungry'],
    answer: 'angry or sad',
  ...
  },
  {
    ...
    grade: 'S1',
    type: 'meaning',
    question: 'Choose the best meaning of "moved":',
    word: 'moved',
    options: ['touched emotionally', 'very tired', 'very bored', 'very noisy'],
    answer: 'touched emotionally',
    explanation: 'moved (adj.) = 感动的。',
    difficulty: 'easy',
  },
  {
    id: 'v1-unit-007',
    grade: 'S1',
    type: 'meaning',
    question: 'Choose the best meaning of "caring":',
    word: 'caring',
    options: ['kind and helpful', 'loud and rude', 'lazy and slow', 'cold and unfriendly'],
