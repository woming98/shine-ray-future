...
const formulaLatexMap = new Map<string, string>([
  ...
  ['ds = v dt', 'ds=v\\,dt'],
  ['area = velocity × time', '\\mathrm{area}=\\mathrm{velocity}\\times\\mathrm{time}'],
  ['area = ∫v dt', '\\mathrm{area}=\\int v\\,dt'],
  ['displacement = ∫v dt', '\\mathrm{displacement}=\\int v\\,dt'],
  ['area under v-t graph = ∫v dt = displacement', '\\mathrm{area\\ under\\ }v\\textrm{-}t\\mathrm{\\ graph}=\\int v\\,dt=\\mathrm{displacement}'],
  ['(m s^-1) × s = m', '(\\mathrm{m\\,s^{-1}})(\\mathrm{s})=\\mathrm{m}'],
  ['(m s^-1)(s) = m', '(\\mathrm{m\\,s^{-1}})(\\mathrm{s})=\\mathrm{m}'],
  ['m s^-2', '\\mathrm{m\\,s^{-2}}'],
  ['kg m s^-1', '\\mathrm{kg\\,m\\,s^{-1}}'],
  ['10^-6', '10^{-6}'],
  ['10⁻⁶', '10^{-6}'],
  ['10^-8', '10^{-8}'],
  ['10⁻⁸', '10^{-8}'],
