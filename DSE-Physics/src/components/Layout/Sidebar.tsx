        ...
        <>
          ...
          >
            ...
            <div className="p-4 border-b border-white/10">
              <div className="bg-gradient-to-r from-ray-500/20 to-orange-500/20 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-ray-400 to-orange-500 flex items-center justify-center">
                ...
                <div className="mt-3 flex items-center justify-between text-xs">
                  ...
                  <span className="text-ray-400 font-medium">{stats.longestStreak} 天</span>
                </div>
              </div>
            </div>
                ...
                {mainNavItems.map((item) => {
                  ...
                  return (
                    <li key={item.path}>
                      ...
                      >
                        <item.icon className={`w-5 h-5 ${isActive ? 'text-shine-400' : ''}`} />
                        <span className="font-medium">{item.label}</span>
                        {isActive && (
                          <motion.div
                            layoutId="activeNav"
                            className="ml-auto w-1.5 h-1.5 rounded-full bg-shine-400"
                          />
                        )}
                      </Link>
                    </li>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className={`font-medium truncate ${
                            isActive ? 'text-shine-400' : 'text-slate-300 group-hover:text-white'
                          }`}>
                            {topic.nameCN}
                          </p>
                        ...
                        <ChevronRight className={`w-4 h-4 transition-transform ${
                          isActive ? 'text-shine-400' : 'text-slate-500 group-hover:translate-x-1'
                        }`} />
                      </Link>
                    </li>
                  );
            ...
            <div className="p-4 border-t border-white/10">
              ...
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <motion.div
                  ...
                  className="h-full bg-gradient-to-r from-shine-400 to-ray-500 rounded-full progress-bar"
                />
              </div>
            </div>
          </motion.aside>
