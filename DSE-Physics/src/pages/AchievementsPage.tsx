...
export default function AchievementsPage() {
  ...
  return (
    ...
    >
      {/* 页面标题 */}
      <div>
        <h1 className="text-3xl font-display font-bold text-white">成就系统</h1>
        <p className="text-slate-400 mt-2">记录你的学习里程碑，收集专属徽章</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex items-center gap-6">
            <ProgressRing progress={levelProgress} size={100} strokeWidth={8}>
              <div className="text-center">
                <p className="text-3xl font-bold text-white">Lv.{user?.level || 1}</p>
              </div>
            </ProgressRing>
            <div>
              <h3 className="text-lg font-bold text-white mb-1">物理探索者</h3>
              <p className="text-slate-400 text-sm mb-3">
                距离下一级还需 {expToNextLevel} 经验
              </p>
              <div className="flex items-center gap-2">
                <Star className="w-4 h-4 text-ray-400" />
                <span className="text-white font-medium">{user?.experience || 0} XP</span>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card hover={false} className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">成就已解锁</p>
            </div>
          </div>
          <div className="mt-4">
        ...
        <Card hover={false} className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-3xl font-bold text-white">{stats.currentStreak} 天</p>
              <p className="text-slate-400">连续学习</p>
              <p className="text-slate-500 text-sm">最长: {stats.longestStreak} 天</p>
            </div>
          </div>
        </Card>
      </div>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-white font-bold">{achievement.titleCN}</h3>
                    ...
                    {!achievement.unlocked && (
                      <div className="mt-4">
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-slate-400 text-xs">进度</span>
      ...
      {/* 经验获取方式 */}
      <Card hover={false} className="p-6">
        <h3 className="text-lg font-bold text-white mb-4">如何获取经验</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 bg-white/5 rounded-xl text-center">
            <BookOpen className="w-8 h-8 text-shine-400 mx-auto mb-2" />
            <p className="text-white font-medium">完成章节学习</p>
            <p className="text-shine-400">+50 XP</p>
          </div>
          <div className="p-4 bg-white/5 rounded-xl text-center">
            <Target className="w-8 h-8 text-green-400 mx-auto mb-2" />
            <p className="text-white font-medium">正确回答题目</p>
            <p className="text-green-400">+10 XP</p>
          </div>
          <div className="p-4 bg-white/5 rounded-xl text-center">
            <Trophy className="w-8 h-8 text-yellow-400 mx-auto mb-2" />
            <p className="text-white font-medium">完成测验</p>
            <p className="text-yellow-400">+100 XP</p>
          </div>
          <div className="p-4 bg-white/5 rounded-xl text-center">
            <Flame className="w-8 h-8 text-orange-400 mx-auto mb-2" />
            <p className="text-white font-medium">每日登录</p>
