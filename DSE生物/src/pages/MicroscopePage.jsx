          ...
          >
            ...
            <div 
              className={`w-4 h-4 rounded-full border-2 cursor-pointer transition-all duration-300 ${
                highlightedPart === label.id 
                  ...
                  : 'bg-white/80 border-shineray-blue hover:bg-shineray-orange hover:border-shineray-orange'
              }`}
            >
              {highlightedPart === label.id && (
            ...
            >
              <div className={`px-2 py-1 rounded-lg text-sm font-medium ${
                highlightedPart === label.id 
                  ? 'bg-shineray-orange text-white shadow-lg' 
...
function MicroscopePartsList({ highlightedPart, setHighlightedPart }) {
  ...
  return (
    <div className="space-y-2">
      <h3 className="font-display font-bold text-bio-dark mb-3 flex items-center gap-2">
        <BookOpen className="w-5 h-5 text-shineray-orange" />
        Parts of a Compound Microscope
      </h3>
      <p className="text-sm text-bio-dark/60 mb-4">
          ...
          <div
            ...
            className={`p-3 rounded-lg transition-all duration-300 cursor-pointer ${
              highlightedPart === part.id 
                ...
                : 'bg-white/50 hover:bg-shineray-blue/10 border border-transparent'
            }`}
          ...
          >
            <div className="flex items-start gap-3">
              <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${
                highlightedPart === part.id ? 'bg-shineray-orange text-white' : 'bg-gray-200 text-gray-600'
              }`}>
                {part.num}
              </span>
              <div className="flex-1">
                ...
                <p className="text-xs text-bio-dark/60 mt-0.5">{part.desc}</p>
              </div>
            </div>
          </div>
        ))}
  ...
  return (
    <div className="card-bio">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-bio-dark/80">
                    {item.text}
                  </p>
                  {item.vocab && (
      ...
      <div className="mt-4 p-3 bg-shineray-blue/10 border border-shineray-blue/20 rounded-lg">
        ...
        <p className="text-sm text-bio-dark font-mono">
          Total magnification = <VocabularyWord word="eyepiece" /> × <VocabularyWord word="objective" />
        </p>
        <p className="text-xs text-bio-dark/60 mt-1">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className={`px-6 py-3 rounded-xl font-medium transition-all ${
              activeSection === 'procedure'
                ? 'bg-shineray-blue text-white shadow-lg'
                : 'bg-white text-gray-600 hover:bg-gray-50 border border-gray-200'
            }`}
          >
            📝 Observation Guide
        ...
        {activeSection === 'diagram' && (
          ...
          >
            {/* Diagram */}
            <div className="card-bio">
              <h2 className="font-display font-bold text-xl text-bio-dark mb-4 text-center">
              ...
              />
              <p className="text-center text-sm text-bio-dark/50 mt-4">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="text-left py-2 px-3 text-bio-dark/70">Feature</th>
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100">
                      <td className="py-2 px-3 text-bio-dark/70">Area observed</td>
        ...
        {activeSection === 'simulator' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <div className="flex items-center justify-center gap-4 mt-6">
                  <div className="flex items-center gap-2 glass rounded-xl px-4 py-2">
                    ...
                    >
                      <ZoomOut className="w-5 h-5 text-bio-dark" />
                    </button>
                    <span className="text-bio-dark font-mono min-w-[60px] text-center">
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg hover:bg-bio-accent/20 transition-colors"
                    >
                      <ZoomIn className="w-5 h-5 text-bio-dark" />
                    </button>
                  </div>
                  
                  <button
                    onClick={handleReset}
                    className="flex items-center gap-2 px-4 py-2 rounded-xl glass hover:bg-bio-accent/20 transition-colors"
                  >
                    <RotateCcw className="w-5 h-5 text-bio-dark" />
                    <span className="text-bio-dark text-sm">Reset</span>
                  </button>
                </div>
                
                {/* 操作提示 */}
                <div className="flex items-center justify-center gap-6 mt-4 text-sm text-bio-dark/50">
            ...
            >
              ...
              <div className="card-bio">
                <h3 className="font-display font-bold text-bio-dark mb-4 flex items-center gap-2">
                  <Eye className="w-5 h-5 text-bio-accent" />
                  Select Sample
                </h3>
                <div className="space-y-2">
                    ...
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-xl transition-all ${
                        microscopeSample === sample.id
                          ? 'bg-bio-accent/20 border border-bio-accent/40'
                          : 'bg-gray-50 hover:bg-bio-accent/10 border border-transparent'
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="font-medium text-bio-dark">{sample.name}</h4>
                          <p className="text-xs text-bio-dark/60">{sample.nameCn}</p>
                        </div>
                      </div>
                    </button>
                  ))}
              ...
              <div className="card-bio">
                <h3 className="font-display font-bold text-bio-dark mb-4 flex items-center gap-2">
                  <Lightbulb className="w-5 h-5 text-bio-accent" />
                ...
                />
                <div className="flex justify-between text-sm text-bio-dark/50 mt-2">
                  <span>Dim</span>
              ...
              <div className="card-bio">
                <h3 className="font-display font-bold text-bio-dark mb-4 flex items-center gap-2">
                  <Settings className="w-5 h-5 text-bio-accent" />
                  Sample Info
                </h3>
                <div className="space-y-3">
                  <div>
                    <p className="text-bio-accent text-sm">Sample Name</p>
                    <p className="text-bio-dark">{currentSample?.name}</p>
                  </div>
                  <div>
                    <p className="text-bio-accent text-sm">Cell Type</p>
                    <p className="text-bio-dark">
                      {currentSample?.type === 'plant' ? 'Plant Cell' : 'Animal Cell'}
                    </p>
                  </div>
                  <div>
                    <p className="text-bio-accent text-sm">Suggested <VocabularyWord word="magnification" /></p>
                    <p className="text-bio-dark">{currentSample?.magnification}</p>
                  </div>
                  <div>
                    <p className="text-bio-accent text-sm">Visible Structures</p>
                    <div className="flex flex-wrap gap-2 mt-1">
                      {currentSample?.features.map(f => (
                        <span 
                          key={f}
                          className="px-2 py-1 rounded-lg bg-bio-accent/20 text-bio-accent text-xs"
                        >
